...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 08 62 00 00    	pushl  0x6208
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 08 62 00 00    	pushl  0x6208
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 08 62 00 00    	pushl  0x6208
  ...
  if(pid == 0){
    ...
    if(unlink("../iputdir") < 0){
     ...
     257:	68 48 40 00 00       	push   $0x4048
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     278:	68 a2 40 00 00       	push   $0x40a2
     27d:	ff 35 08 62 00 00    	pushl  0x6208
     ...
     293:	68 53 40 00 00       	push   $0x4053
     298:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "fork failed\n");
     2a8:	51                   	push   %ecx
     2a9:	51                   	push   %ecx
     2aa:	68 65 4f 00 00       	push   $0x4f65
     2af:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    exit();
     ...
     2bf:	50                   	push   %eax
     2c0:	50                   	push   %eax
     2c1:	68 8e 40 00 00       	push   $0x408e
     2c6:	ff 35 08 62 00 00    	pushl  0x6208
     ...
     2d6:	52                   	push   %edx
     2d7:	52                   	push   %edx
     2d8:	68 24 40 00 00       	push   $0x4024
     2dd:	ff 35 08 62 00 00    	pushl  0x6208
...
000002f0 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     2f6:	68 b4 40 00 00       	push   $0x40b4
     2fb:	ff 35 08 62 00 00    	pushl  0x6208
     301:	e8 2a 37 00 00       	call   3a30 <printf>
  if(mkdir("oidir") < 0){
     306:	c7 04 24 c3 40 00 00 	movl   $0x40c3,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     32f:	6a 02                	push   $0x2
     331:	68 c3 40 00 00       	push   $0x40c3
    ...
    if(fd >= 0){
     ...
     345:	68 48 50 00 00       	push   $0x5048
     34a:	ff 35 08 62 00 00    	pushl  0x6208
  ...
  if(unlink("oidir") != 0){
     36a:	c7 04 24 c3 40 00 00 	movl   $0x40c3,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     385:	68 ec 40 00 00       	push   $0x40ec
     38a:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "mkdir oidir failed\n");
     3a5:	51                   	push   %ecx
     3a6:	51                   	push   %ecx
     3a7:	68 c9 40 00 00       	push   $0x40c9
     3ac:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "fork failed\n");
     3bc:	52                   	push   %edx
     3bd:	52                   	push   %edx
     3be:	68 65 4f 00 00       	push   $0x4f65
     3c3:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "unlink failed\n");
     3d3:	50                   	push   %eax
     3d4:	50                   	push   %eax
     3d5:	68 dd 40 00 00       	push   $0x40dd
     3da:	ff 35 08 62 00 00    	pushl  0x6208
...
000003f0 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     3f6:	68 fe 40 00 00       	push   $0x40fe
     3fb:	ff 35 08 62 00 00    	pushl  0x6208
     401:	e8 2a 36 00 00       	call   3a30 <printf>
  fd = open("echo", 0);
     406:	58                   	pop    %eax
     407:	5a                   	pop    %edx
     408:	6a 00                	push   $0x0
     40a:	68 09 41 00 00       	push   $0x4109
  ...
  fd = open("doesnotexist", 0);
     ...
     425:	59                   	pop    %ecx
     426:	6a 00                	push   $0x0
     428:	68 21 41 00 00       	push   $0x4121
  ...
  printf(stdout, "open test ok\n");
     ...
     43c:	68 4c 41 00 00       	push   $0x414c
     441:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "open echo failed!\n");
     451:	50                   	push   %eax
     452:	50                   	push   %eax
     453:	68 0e 41 00 00       	push   $0x410e
     458:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     468:	50                   	push   %eax
     469:	50                   	push   %eax
     46a:	68 2e 41 00 00       	push   $0x412e
     46f:	ff 35 08 62 00 00    	pushl  0x6208
...
00000480 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     488:	68 5a 41 00 00       	push   $0x415a
     48d:	ff 35 08 62 00 00    	pushl  0x6208
     493:	e8 98 35 00 00       	call   3a30 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     498:	58                   	pop    %eax
     499:	5a                   	pop    %edx
     49a:	68 02 02 00 00       	push   $0x202
     49f:	68 6b 41 00 00       	push   $0x416b
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4bb:	68 71 41 00 00       	push   $0x4171
     4c0:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4d3:	6a 0a                	push   $0xa
     4d5:	68 a8 41 00 00       	push   $0x41a8
     4da:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4ef:	6a 0a                	push   $0xa
     4f1:	68 b3 41 00 00       	push   $0x41b3
     4f6:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     513:	68 be 41 00 00       	push   $0x41be
     518:	ff 35 08 62 00 00    	pushl  0x6208
  ...
  fd = open("small", O_RDONLY);
     ...
     52c:	5e                   	pop    %esi
     52d:	6a 00                	push   $0x0
     52f:	68 6b 41 00 00       	push   $0x416b
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     549:	68 c9 41 00 00       	push   $0x41c9
     54e:	ff 35 08 62 00 00    	pushl  0x6208
     554:	e8 d7 34 00 00       	call   3a30 <printf>
  i = read(fd, buf, 2000);
     559:	83 c4 0c             	add    $0xc,%esp
     55c:	68 d0 07 00 00       	push   $0x7d0
     561:	68 e0 89 00 00       	push   $0x89e0
     566:	53                   	push   %ebx
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     57d:	68 fd 41 00 00       	push   $0x41fd
     582:	ff 35 08 62 00 00    	pushl  0x6208
     588:	e8 a3 34 00 00       	call   3a30 <printf>
  close(fd);
     58d:	89 1c 24             	mov    %ebx,(%esp)
     590:	e8 35 33 00 00       	call   38ca <close>
  if(unlink("small") < 0){
     595:	c7 04 24 6b 41 00 00 	movl   $0x416b,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     5ab:	68 25 42 00 00       	push   $0x4225
     5b0:	ff 35 08 62 00 00    	pushl  0x6208
     ...
     5c8:	53                   	push   %ebx
     5c9:	68 6c 50 00 00       	push   $0x506c
     5ce:	ff 35 08 62 00 00    	pushl  0x6208
     ...
     5e1:	53                   	push   %ebx
     5e2:	68 90 50 00 00       	push   $0x5090
     5e7:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "error: open small failed!\n");
     5f7:	51                   	push   %ecx
     5f8:	51                   	push   %ecx
     5f9:	68 e2 41 00 00       	push   $0x41e2
     5fe:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "read failed\n");
     60e:	52                   	push   %edx
     60f:	52                   	push   %edx
     610:	68 29 45 00 00       	push   $0x4529
     615:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "unlink small failed\n");
     625:	50                   	push   %eax
     626:	50                   	push   %eax
     627:	68 10 42 00 00       	push   $0x4210
     62c:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "error: creat small failed!\n");
     63c:	50                   	push   %eax
     63d:	50                   	push   %eax
     63e:	68 8c 41 00 00       	push   $0x418c
     643:	ff 35 08 62 00 00    	pushl  0x6208
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     668:	68 39 42 00 00       	push   $0x4239
     66d:	ff 35 08 62 00 00    	pushl  0x6208
     673:	e8 b8 33 00 00       	call   3a30 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     678:	58                   	pop    %eax
     679:	5a                   	pop    %edx
     67a:	68 02 02 00 00       	push   $0x202
     67f:	68 b3 42 00 00       	push   $0x42b3
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6a3:	89 1d e0 89 00 00    	mov    %ebx,0x89e0
    if(write(fd, buf, 512) != 512){
     6a9:	68 00 02 00 00       	push   $0x200
     6ae:	68 e0 89 00 00       	push   $0x89e0
     6b3:	56                   	push   %esi
  ...
  fd = open("big", O_RDONLY);
     ...
     6dc:	5e                   	pop    %esi
     6dd:	6a 00                	push   $0x0
     6df:	68 b3 42 00 00       	push   $0x42b3
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     70b:	a1 e0 89 00 00       	mov    0x89e0,%eax
    ...
    i = read(fd, buf, 512);
     ...
     71f:	68 e0 89 00 00       	push   $0x89e0
     724:	56                   	push   %esi
  ...
  if(unlink("big") < 0){
     746:	c7 04 24 b3 42 00 00 	movl   $0x42b3,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     760:	68 da 42 00 00       	push   $0x42da
     765:	ff 35 08 62 00 00    	pushl  0x6208
     ...
     77d:	53                   	push   %ebx
     77e:	68 63 42 00 00       	push   $0x4263
     783:	ff 35 08 62 00 00    	pushl  0x6208
     ...
     793:	50                   	push   %eax
     794:	53                   	push   %ebx
     795:	68 b4 50 00 00       	push   $0x50b4
     79a:	ff 35 08 62 00 00    	pushl  0x6208
     ...
     7ad:	50                   	push   %eax
     7ae:	68 b7 42 00 00       	push   $0x42b7
     7b3:	ff 35 08 62 00 00    	pushl  0x6208
     ...
     7c9:	68 9a 42 00 00       	push   $0x429a
     7ce:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "error: open big failed!\n");
     7de:	51                   	push   %ecx
     7df:	51                   	push   %ecx
     7e0:	68 81 42 00 00       	push   $0x4281
     7e5:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "error: creat big failed!\n");
     7f5:	50                   	push   %eax
     7f6:	50                   	push   %eax
     7f7:	68 49 42 00 00       	push   $0x4249
     7fc:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "unlink big failed\n");
     80c:	50                   	push   %eax
     80d:	50                   	push   %eax
     80e:	68 c7 42 00 00       	push   $0x42c7
     813:	ff 35 08 62 00 00    	pushl  0x6208
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     83c:	68 d4 50 00 00       	push   $0x50d4
     841:	ff 35 08 62 00 00    	pushl  0x6208
     847:	e8 e4 31 00 00       	call   3a30 <printf>
  name[0] = 'a';
     84c:	c6 05 e0 a9 00 00 61 	movb   $0x61,0xa9e0
  name[2] = '\0';
     853:	c6 05 e2 a9 00 00 00 	movb   $0x0,0xa9e2
     85a:	83 c4 10             	add    $0x10,%esp
     85d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     860:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     863:	88 1d e1 a9 00 00    	mov    %bl,0xa9e1
     869:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     86c:	68 02 02 00 00       	push   $0x202
     871:	68 e0 a9 00 00       	push   $0xa9e0
  ...
  name[0] = 'a';
     88b:	c6 05 e0 a9 00 00 61 	movb   $0x61,0xa9e0
  name[2] = '\0';
     892:	c6 05 e2 a9 00 00 00 	movb   $0x0,0xa9e2
     899:	bb 30 00 00 00       	mov    $0x30,%ebx
     89e:	66 90                	xchg   %ax,%ax
    unlink(name);
     8a0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8a3:	88 1d e1 a9 00 00    	mov    %bl,0xa9e1
     8a9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8ac:	68 e0 a9 00 00       	push   $0xa9e0
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c1:	68 fc 50 00 00       	push   $0x50fc
     8c6:	ff 35 08 62 00 00    	pushl  0x6208
...
000008e0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     8e6:	68 e8 42 00 00       	push   $0x42e8
     8eb:	ff 35 08 62 00 00    	pushl  0x6208
     8f1:	e8 3a 31 00 00       	call   3a30 <printf>
  if(mkdir("dir0") < 0){
     8f6:	c7 04 24 f4 42 00 00 	movl   $0x42f4,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     90c:	68 f4 42 00 00       	push   $0x42f4
  ...
  if(chdir("..") < 0){
     ...
     924:	68 99 48 00 00       	push   $0x4899
  ...
  if(unlink("dir0") < 0){
     ...
     938:	68 f4 42 00 00       	push   $0x42f4
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     94c:	68 31 43 00 00       	push   $0x4331
     951:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "mkdir failed\n");
     961:	50                   	push   %eax
     962:	50                   	push   %eax
     963:	68 24 40 00 00       	push   $0x4024
     968:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "unlink dir0 failed\n");
     978:	50                   	push   %eax
     979:	50                   	push   %eax
     97a:	68 1d 43 00 00       	push   $0x431d
     97f:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "chdir .. failed\n");
     98f:	52                   	push   %edx
     990:	52                   	push   %edx
     991:	68 0c 43 00 00       	push   $0x430c
     996:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    printf(stdout, "chdir dir0 failed\n");
     9a6:	51                   	push   %ecx
     9a7:	51                   	push   %ecx
     9a8:	68 f9 42 00 00       	push   $0x42f9
     9ad:	ff 35 08 62 00 00    	pushl  0x6208
...
000009c0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     9c6:	68 40 43 00 00       	push   $0x4340
     9cb:	ff 35 08 62 00 00    	pushl  0x6208
     9d1:	e8 5a 30 00 00       	call   3a30 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 0c 62 00 00       	push   $0x620c
     9dd:	68 09 41 00 00       	push   $0x4109
    ...
    printf(stdout, "exec echo failed\n");
     9f0:	50                   	push   %eax
     9f1:	50                   	push   %eax
     9f2:	68 4b 43 00 00       	push   $0x434b
     9f7:	ff 35 08 62 00 00    	pushl  0x6208
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a60:	57                   	push   %edi
     a61:	68 e0 89 00 00       	push   $0x89e0
     ...
     a7e:	f7 d9                	neg    %ecx
     a80:	38 9c 0b e0 89 00 00 	cmp    %bl,0x89e0(%ebx,%ecx,1)
     ...
     aaa:	68 7a 43 00 00       	push   $0x437a
     aaf:	6a 01                	push   $0x1
    ...
    close(fds[0]);
     ...
     ade:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     ae0:	88 84 03 e0 89 00 00 	mov    %al,0x89e0(%ebx,%eax,1)
     ...
     af6:	68 e0 89 00 00       	push   $0x89e0
  ...
  printf(1, "pipe1 ok\n");
     b3d:	5a                   	pop    %edx
     b3e:	59                   	pop    %ecx
     b3f:	68 9f 43 00 00       	push   $0x439f
     b44:	6a 01                	push   $0x1
     ...
     b5a:	68 88 43 00 00       	push   $0x4388
     b5f:	6a 01                	push   $0x1
    ...
    printf(1, "pipe() failed\n");
     b6b:	57                   	push   %edi
     b6c:	57                   	push   %edi
     b6d:	68 5d 43 00 00       	push   $0x435d
     b72:	6a 01                	push   $0x1
    ...
    printf(1, "fork() failed\n");
     b7e:	50                   	push   %eax
     b7f:	50                   	push   %eax
     b80:	68 a9 43 00 00       	push   $0x43a9
     b85:	6a 01                	push   $0x1
    ...
    exit();
     ...
     b91:	56                   	push   %esi
     b92:	56                   	push   %esi
     b93:	68 6c 43 00 00       	push   $0x436c
     b98:	6a 01                	push   $0x1
...
00000bb0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     bb9:	68 b8 43 00 00       	push   $0x43b8
     bbe:	6a 01                	push   $0x1
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c0a:	6a 01                	push   $0x1
     c0c:	68 7d 49 00 00       	push   $0x497d
     ...
     c21:	50                   	push   %eax
     c22:	50                   	push   %eax
     c23:	68 c2 43 00 00       	push   $0x43c2
     c28:	6a 01                	push   $0x1
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c55:	68 e0 89 00 00       	push   $0x89e0
    ...
    printf(1, "preempt read error");
     c6a:	50                   	push   %eax
     c6b:	50                   	push   %eax
     c6c:	68 d6 43 00 00       	push   $0x43d6
     c71:	6a 01                	push   $0x1
  ...
  printf(1, "kill... ");
     c8e:	58                   	pop    %eax
     c8f:	5a                   	pop    %edx
     c90:	68 e9 43 00 00       	push   $0x43e9
     c95:	6a 01                	push   $0x1
  ...
  printf(1, "wait... ");
     cb4:	59                   	pop    %ecx
     cb5:	5b                   	pop    %ebx
     cb6:	68 f2 43 00 00       	push   $0x43f2
     cbb:	6a 01                	push   $0x1
  ...
  printf(1, "preempt ok\n");
     cd1:	5e                   	pop    %esi
     cd2:	5f                   	pop    %edi
     cd3:	68 fb 43 00 00       	push   $0x43fb
     cd8:	6a 01                	push   $0x1
...
00000cf0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d1e:	68 65 4f 00 00       	push   $0x4f65
     d23:	6a 01                	push   $0x1
     ...
     d3b:	68 07 44 00 00       	push   $0x4407
     d40:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
     ...
     d5b:	68 17 44 00 00       	push   $0x4417
     d60:	6a 01                	push   $0x1
...
00000d80 <mem>:
{
  ...
  printf(1, "mem test\n");
     d8b:	68 24 44 00 00       	push   $0x4424
     d90:	6a 01                	push   $0x1
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     e01:	58                   	pop    %eax
     e02:	5a                   	pop    %edx
     e03:	68 48 44 00 00       	push   $0x4448
     e08:	6a 01                	push   $0x1
    ...
    exit();
     ...
     e1b:	68 2e 44 00 00       	push   $0x442e
     e20:	6a 01                	push   $0x1
...
00000e50 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     edf:	68 50 51 00 00       	push   $0x5150
     ee4:	6a 01                	push   $0x1
  ...
  fd = open("sharedfd", 0);
     ...
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 5f 44 00 00       	push   $0x445f
  ...
  unlink("sharedfd");
     f81:	c7 04 24 5f 44 00 00 	movl   $0x445f,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fa3:	68 68 44 00 00       	push   $0x4468
     fa8:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fc3:	68 24 51 00 00       	push   $0x5124
     fc8:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fdd:	68 70 51 00 00       	push   $0x5170
     fe2:	6a 01                	push   $0x1
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ff9:	53                   	push   %ebx
     ffa:	57                   	push   %edi
     ffb:	68 75 44 00 00       	push   $0x4475
    1000:	6a 01                	push   $0x1
...
00001010 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1016:	be 8a 44 00 00       	mov    $0x448a,%esi
  for(pi = 0; pi < 4; pi++){
    101b:	31 db                	xor    %ebx,%ebx
{
    101d:	83 ec 34             	sub    $0x34,%esp
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 d8 8a 44 00 00 	movl   $0x448a,-0x28(%ebp)
    1027:	c7 45 dc d3 45 00 00 	movl   $0x45d3,-0x24(%ebp)
  printf(1, "fourfiles test\n");
    102e:	68 90 44 00 00       	push   $0x4490
    1033:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    1035:	c7 45 e0 d7 45 00 00 	movl   $0x45d7,-0x20(%ebp)
    103c:	c7 45 e4 8d 44 00 00 	movl   $0x448d,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
  ...
  for(i = 0; i < 2; i++){
    ...
    108e:	c7 45 d0 8a 44 00 00 	movl   $0x448a,-0x30(%ebp)
    fd = open(fname, 0);
    ...
    10b8:	68 e0 89 00 00       	push   $0x89e0
    ...
    10ce:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    10d0:	0f be b2 e0 89 00 00 	movsbl 0x89e0(%edx),%esi
  ...
  printf(1, "fourfiles ok\n");
    ...
    1122:	68 ce 44 00 00       	push   $0x44ce
    1127:	6a 01                	push   $0x1
    ...
    1171:	68 e0 89 00 00       	push   $0x89e0
    ...
    1186:	68 e0 89 00 00       	push   $0x89e0
    118b:	56                   	push   %esi
    ...
    11a8:	68 b1 44 00 00       	push   $0x44b1
    11ad:	6a 01                	push   $0x1
    ...
    11b9:	51                   	push   %ecx
    11ba:	51                   	push   %ecx
    11bb:	68 2b 47 00 00       	push   $0x472b
    11c0:	6a 01                	push   $0x1
    ...
    11cc:	53                   	push   %ebx
    11cd:	53                   	push   %ebx
    11ce:	68 65 4f 00 00       	push   $0x4f65
    11d3:	6a 01                	push   $0x1
    ...
    11df:	50                   	push   %eax
    11e0:	53                   	push   %ebx
    11e1:	68 bd 44 00 00       	push   $0x44bd
    11e6:	6a 01                	push   $0x1
    ...
    11f2:	52                   	push   %edx
    11f3:	50                   	push   %eax
    11f4:	68 a0 44 00 00       	push   $0x44a0
    11f9:	6a 01                	push   $0x1
    ...
    1216:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    121b:	68 dc 44 00 00       	push   $0x44dc
    1220:	6a 01                	push   $0x1
  ...
  printf(1, "createdelete ok\n");
    ...
    1314:	68 ef 44 00 00       	push   $0x44ef
    1319:	6a 01                	push   $0x1
    ...
    13b2:	52                   	push   %edx
    13b3:	52                   	push   %edx
    13b4:	68 dd 40 00 00       	push   $0x40dd
    13b9:	6a 01                	push   $0x1
    ...
    13d0:	57                   	push   %edi
    13d1:	68 9c 51 00 00       	push   $0x519c
    13d6:	6a 01                	push   $0x1
    ...
    13e2:	51                   	push   %ecx
    13e3:	51                   	push   %ecx
    13e4:	68 2b 47 00 00       	push   $0x472b
    13e9:	6a 01                	push   $0x1
    ...
    13f5:	53                   	push   %ebx
    13f6:	53                   	push   %ebx
    13f7:	68 65 4f 00 00       	push   $0x4f65
    13fc:	6a 01                	push   $0x1
    ...
    1410:	50                   	push   %eax
    1411:	57                   	push   %edi
    1412:	68 c0 51 00 00       	push   $0x51c0
    1417:	6a 01                	push   $0x1
...
00001430 <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14e1:	68 e0 89 00 00       	push   $0x89e0
    14e6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14f8:	80 3d e0 89 00 00 68 	cmpb   $0x68,0x89e0
    14ff:	75 6b                	jne    156c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    1501:	83 ec 04             	sub    $0x4,%esp
    1504:	6a 0a                	push   $0xa
    1506:	68 e0 89 00 00       	push   $0x89e0
    150b:	53                   	push   %ebx
...
000015c0 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1694:	68 e0 89 00 00       	push   $0x89e0
    1699:	50                   	push   %eax
  ...
  printf(1, "linktest ok\n");
    ...
    174b:	52                   	push   %edx
    174c:	52                   	push   %edx
    174d:	68 08 52 00 00       	push   $0x5208
    1752:	6a 01                	push   $0x1
    ...
    1797:	50                   	push   %eax
    1798:	50                   	push   %eax
    1799:	68 e0 51 00 00       	push   $0x51e0
    179e:	6a 01                	push   $0x1
    ...
    17db:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  printf(1, "concreate test\n");
    17e3:	68 7d 46 00 00       	push   $0x467d
    17e8:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1895:	53                   	push   %ebx
    1896:	68 90 46 00 00       	push   $0x4690
    189b:	6a 01                	push   $0x1
    ...
    18b3:	53                   	push   %ebx
    18b4:	68 8d 46 00 00       	push   $0x468d
  ...
  for(i = 0; i < 40; i++){
    18d3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18d6:	53                   	push   %ebx
    18d7:	68 8d 46 00 00       	push   $0x468d
  ...
  fd = open(".", 0);
    ...
    1903:	58                   	pop    %eax
    1904:	6a 00                	push   $0x0
    1906:	68 9a 48 00 00       	push   $0x489a
  ...
  printf(1, "concreate ok\n");
    ...
    1a53:	68 e2 46 00 00       	push   $0x46e2
    1a58:	6a 01                	push   $0x1
    ...
    1a6a:	68 65 4f 00 00       	push   $0x4f65
    1a6f:	6a 01                	push   $0x1
    ...
    1a7b:	51                   	push   %ecx
    1a7c:	51                   	push   %ecx
    1a7d:	68 2c 52 00 00       	push   $0x522c
    1a82:	6a 01                	push   $0x1
    ...
    1a91:	53                   	push   %ebx
    1a92:	50                   	push   %eax
    1a93:	68 c5 46 00 00       	push   $0x46c5
    1a98:	6a 01                	push   $0x1
    ...
    1aa7:	56                   	push   %esi
    1aa8:	50                   	push   %eax
    1aa9:	68 ac 46 00 00       	push   $0x46ac
    1aae:	6a 01                	push   $0x1
...
00001ad0 <linkunlink>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b5d:	68 7d 49 00 00       	push   $0x497d
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b86:	68 05 47 00 00       	push   $0x4705
    1b8b:	6a 01                	push   $0x1
...
00001be0 <bigdir>:
{
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1c3c:	57                   	push   %edi
    1c3d:	68 21 47 00 00       	push   $0x4721
    name[1] = '0' + (i / 64);
...
00001d10 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e06:	68 e0 89 00 00       	push   $0x89e0
    1e0b:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e1d:	80 3d e0 89 00 00 66 	cmpb   $0x66,0x89e0
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f05:	68 e0 89 00 00       	push   $0x89e0
    1f0a:	50                   	push   %eax
  ...
  printf(1, "subdir ok\n");
    ...
    21a3:	52                   	push   %edx
    21a4:	52                   	push   %edx
    21a5:	68 d0 52 00 00       	push   $0x52d0
    21aa:	6a 01                	push   $0x1
    ...
    21c9:	51                   	push   %ecx
    21ca:	51                   	push   %ecx
    21cb:	68 40 53 00 00       	push   $0x5340
    21d0:	6a 01                	push   $0x1
    ...
    2215:	51                   	push   %ecx
    2216:	51                   	push   %ecx
    2217:	68 88 52 00 00       	push   $0x5288
    221c:	6a 01                	push   $0x1
    ...
    2228:	53                   	push   %ebx
    2229:	53                   	push   %ebx
    222a:	68 1c 53 00 00       	push   $0x531c
    222f:	6a 01                	push   $0x1
    ...
    223b:	50                   	push   %eax
    223c:	50                   	push   %eax
    223d:	68 f8 52 00 00       	push   $0x52f8
    2242:	6a 01                	push   $0x1
    ...
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    22af:	68 ac 52 00 00       	push   $0x52ac
    22b4:	6a 01                	push   $0x1
    ...
    22d3:	50                   	push   %eax
    22d4:	50                   	push   %eax
    22d5:	68 60 52 00 00       	push   $0x5260
    22da:	6a 01                	push   $0x1
    ...
    2332:	51                   	push   %ecx
    2333:	51                   	push   %ecx
    2334:	68 64 53 00 00       	push   $0x5364
    2339:	6a 01                	push   $0x1
...
000023f0 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    243e:	53                   	push   %ebx
    243f:	68 e0 89 00 00       	push   $0x89e0
    2444:	50                   	push   %eax
    ...
    2454:	53                   	push   %ebx
    2455:	68 e0 89 00 00       	push   $0x89e0
    245a:	56                   	push   %esi
...
000024d0 <bigfile>:
{
  ...
  for(i = 0; ; i++){
    ...
    258b:	0f be 05 e0 89 00 00 	movsbl 0x89e0,%eax
    2592:	89 fa                	mov    %edi,%edx
    2594:	d1 fa                	sar    %edx
    2596:	39 d0                	cmp    %edx,%eax
    2598:	75 6e                	jne    2608 <bigfile+0x138>
    259a:	0f be 15 0b 8b 00 00 	movsbl 0x8b0b,%edx
  ...
  for(i = 0; ; i++){
    ...
    25b6:	68 e0 89 00 00       	push   $0x89e0
    25bb:	56                   	push   %esi
...
000026a0 <fourteen>:
{
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26cc:	68 84 53 00 00       	push   $0x5384
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26e9:	68 d4 53 00 00       	push   $0x53d4
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 44 54 00 00       	push   $0x5444
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    273b:	68 e0 54 00 00       	push   $0x54e0
  ...
  printf(1, "fourteen ok\n");
    ...
    2773:	50                   	push   %eax
    2774:	50                   	push   %eax
    2775:	68 00 55 00 00       	push   $0x5500
    277a:	6a 01                	push   $0x1
    ...
    2786:	52                   	push   %edx
    2787:	52                   	push   %edx
    2788:	68 b0 54 00 00       	push   $0x54b0
    278d:	6a 01                	push   $0x1
    ...
    2799:	51                   	push   %ecx
    279a:	51                   	push   %ecx
    279b:	68 74 54 00 00       	push   $0x5474
    27a0:	6a 01                	push   $0x1
    ...
    27ac:	51                   	push   %ecx
    27ad:	51                   	push   %ecx
    27ae:	68 04 54 00 00       	push   $0x5404
    27b3:	6a 01                	push   $0x1
    ...
    27bf:	50                   	push   %eax
    27c0:	50                   	push   %eax
    27c1:	68 a4 53 00 00       	push   $0x53a4
    27c6:	6a 01                	push   $0x1
...
00002960 <dirfile>:
{
  ...
  printf(1, "dir vs file OK\n");
    ...
    2af8:	53                   	push   %ebx
    2af9:	53                   	push   %ebx
    2afa:	68 54 55 00 00       	push   $0x5554
    2aff:	6a 01                	push   $0x1
    ...
    2b1e:	50                   	push   %eax
    2b1f:	50                   	push   %eax
    2b20:	68 34 55 00 00       	push   $0x5534
    2b25:	6a 01                	push   $0x1
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test OK\n");
    ...
    2cf3:	68 74 55 00 00       	push   $0x5574
    2cf8:	6a 01                	push   $0x1
    ...
    2d0c:	68 df 4d 00 00       	push   $0x4ddf
    2d11:	6a 01                	push   $0x1
    ...
    2d1d:	50                   	push   %eax
    2d1e:	50                   	push   %eax
    2d1f:	68 f3 4d 00 00       	push   $0x4df3
    2d24:	6a 01                	push   $0x1
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d40:	ff 35 08 62 00 00    	pushl  0x6208
  ...
  *lastaddr = 99;
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f5a:	6a 01                	push   $0x1
    2f5c:	68 7d 49 00 00       	push   $0x497d
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fce:	68 bc 4e 00 00       	push   $0x4ebc
    2fd3:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    2fed:	56                   	push   %esi
    2fee:	57                   	push   %edi
    2fef:	68 1f 4e 00 00       	push   $0x4e1f
    2ff4:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    3020:	50                   	push   %eax
    3021:	50                   	push   %eax
    3022:	68 a1 4e 00 00       	push   $0x4ea1
    3027:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    3037:	52                   	push   %edx
    3038:	52                   	push   %edx
    3039:	68 5d 43 00 00       	push   $0x435d
    303e:	6a 01                	push   $0x1
    ...
    304d:	50                   	push   %eax
    304e:	56                   	push   %esi
    304f:	68 88 4e 00 00       	push   $0x4e88
    3054:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    306c:	51                   	push   %ecx
    306d:	51                   	push   %ecx
    306e:	68 65 4f 00 00       	push   $0x4f65
    3073:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    3083:	50                   	push   %eax
    3084:	56                   	push   %esi
    3085:	68 68 56 00 00       	push   $0x5668
    308a:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    309a:	53                   	push   %ebx
    309b:	53                   	push   %ebx
    309c:	68 38 56 00 00       	push   $0x5638
    30a1:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    30b1:	57                   	push   %edi
    30b2:	56                   	push   %esi
    30b3:	68 10 56 00 00       	push   $0x5610
    30b8:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    30c8:	50                   	push   %eax
    30c9:	56                   	push   %esi
    30ca:	68 d8 55 00 00       	push   $0x55d8
    30cf:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    30df:	56                   	push   %esi
    30e0:	56                   	push   %esi
    30e1:	68 6d 4e 00 00       	push   $0x4e6d
    30e6:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    30f6:	57                   	push   %edi
    30f7:	57                   	push   %edi
    30f8:	68 98 55 00 00       	push   $0x5598
    30fd:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    3112:	50                   	push   %eax
    3113:	50                   	push   %eax
    3114:	68 51 4e 00 00       	push   $0x4e51
    3119:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    3129:	50                   	push   %eax
    312a:	50                   	push   %eax
    312b:	68 3a 4e 00 00       	push   $0x4e3a
    3130:	ff 35 08 62 00 00    	pushl  0x6208
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    315a:	68 ca 4e 00 00       	push   $0x4eca
    315f:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    319f:	5a                   	pop    %edx
    31a0:	53                   	push   %ebx
    31a1:	68 d9 4e 00 00       	push   $0x4ed9
  ...
  printf(stdout, "validate ok\n");
    ...
    31c4:	68 fd 4e 00 00       	push   $0x4efd
    31c9:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    31e6:	68 e4 4e 00 00       	push   $0x4ee4
    31eb:	ff 35 08 62 00 00    	pushl  0x6208
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3206:	68 0a 4f 00 00       	push   $0x4f0a
    320b:	ff 35 08 62 00 00    	pushl  0x6208
    3211:	e8 1a 08 00 00       	call   3a30 <printf>
    if(uninit[i] != '\0'){
    3216:	83 c4 10             	add    $0x10,%esp
    3219:	80 3d c0 62 00 00 00 	cmpb   $0x0,0x62c0
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    3230:	80 b8 c0 62 00 00 00 	cmpb   $0x0,0x62c0(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    3246:	68 25 4f 00 00       	push   $0x4f25
    324b:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    325e:	68 14 4f 00 00       	push   $0x4f14
    3263:	ff 35 08 62 00 00    	pushl  0x6208
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3286:	68 32 4f 00 00       	push   $0x4f32
  ...
  fd = open("bigarg-ok", 0);
    ...
    32aa:	6a 00                	push   $0x0
    32ac:	68 32 4f 00 00       	push   $0x4f32
  ...
  unlink("bigarg-ok");
    32ca:	c7 04 24 32 4f 00 00 	movl   $0x4f32,(%esp)
    32d1:	e8 1c 06 00 00       	call   38f2 <unlink>
}
    32d6:	83 c4 10             	add    $0x10,%esp
    32d9:	c9                   	leave  
    32da:	c3                   	ret    
    32db:	b8 20 62 00 00       	mov    $0x6220,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    32e0:	c7 00 8c 56 00 00    	movl   $0x568c,(%eax)
    32e6:	83 c0 04             	add    $0x4,%eax
    for(i = 0; i < MAXARG-1; i++)
    32e9:	3d 9c 62 00 00       	cmp    $0x629c,%eax
    32ee:	75 f0                	jne    32e0 <bigargtest+0x60>
    printf(stdout, "bigarg test\n");
    32f0:	51                   	push   %ecx
    32f1:	51                   	push   %ecx
    32f2:	68 3c 4f 00 00       	push   $0x4f3c
    32f7:	ff 35 08 62 00 00    	pushl  0x6208
    args[MAXARG-1] = 0;
    32fd:	c7 05 9c 62 00 00 00 	movl   $0x0,0x629c
    3304:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    330c:	58                   	pop    %eax
    330d:	5a                   	pop    %edx
    330e:	68 20 62 00 00       	push   $0x6220
    3313:	68 09 41 00 00       	push   $0x4109
    3318:	e8 bd 05 00 00       	call   38da <exec>
    printf(stdout, "bigarg test ok\n");
    331d:	59                   	pop    %ecx
    331e:	58                   	pop    %eax
    331f:	68 49 4f 00 00       	push   $0x4f49
    3324:	ff 35 08 62 00 00    	pushl  0x6208
    332a:	e8 01 07 00 00       	call   3a30 <printf>
    fd = open("bigarg-ok", O_CREATE);
    332f:	58                   	pop    %eax
    3330:	5a                   	pop    %edx
    3331:	68 00 02 00 00       	push   $0x200
    3336:	68 32 4f 00 00       	push   $0x4f32
    ...
    334d:	50                   	push   %eax
    334e:	50                   	push   %eax
    334f:	68 72 4f 00 00       	push   $0x4f72
    3354:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    3364:	52                   	push   %edx
    3365:	52                   	push   %edx
    3366:	68 59 4f 00 00       	push   $0x4f59
    336b:	ff 35 08 62 00 00    	pushl  0x6208
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    338b:	68 87 4f 00 00       	push   $0x4f87
    3390:	6a 01                	push   $0x1
    ...
    3413:	50                   	push   %eax
    3414:	68 94 4f 00 00       	push   $0x4f94
    3419:	6a 01                	push   $0x1
    ...
    344a:	68 e0 89 00 00       	push   $0x89e0
    344f:	57                   	push   %edi
    ...
    3462:	56                   	push   %esi
    3463:	68 b0 4f 00 00       	push   $0x4fb0
    3468:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3496:	50                   	push   %eax
    3497:	68 a0 4f 00 00       	push   $0x4fa0
    349c:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    352a:	68 c0 4f 00 00       	push   $0x4fc0
    352f:	6a 01                	push   $0x1
...
00003550 <uio>:
{
  ...
  printf(1, "uio test\n");
    3556:	68 d6 4f 00 00       	push   $0x4fd6
    355b:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    3578:	68 e0 4f 00 00       	push   $0x4fe0
    357d:	6a 01                	push   $0x1
    ...
    359a:	52                   	push   %edx
    359b:	52                   	push   %edx
    359c:	68 6c 57 00 00       	push   $0x576c
    35a1:	6a 01                	push   $0x1
    ...
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    35af:	68 65 4f 00 00       	push   $0x4f65
    35b4:	6a 01                	push   $0x1
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    35c7:	6a 00                	push   $0x0
    35c9:	68 ef 4f 00 00       	push   $0x4fef
  ...
  printf(1, "arg test passed\n");
    35fd:	58                   	pop    %eax
    35fe:	5a                   	pop    %edx
    35ff:	68 01 50 00 00       	push   $0x5001
    3604:	6a 01                	push   $0x1
    ...
    3613:	51                   	push   %ecx
    3614:	51                   	push   %ecx
    3615:	68 f4 4f 00 00       	push   $0x4ff4
    361a:	6a 02                	push   $0x2
...
00003630 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3630:	69 05 04 62 00 00 0d 	imul   $0x19660d,0x6204,%eax
    3637:	66 19 00 
{
    363a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3643:	a3 04 62 00 00       	mov    %eax,0x6204
}
    3648:	c3                   	ret    
    ...
    3999:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    39c7:	f7 f1                	div    %ecx
    39c9:	0f b6 92 c4 57 00 00 	movzbl 0x57c4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3be4:	e9 8f fe ff ff       	jmp    3a78 <printf+0x48>
          s = "(null)";
    3be9:	bb bc 57 00 00       	mov    $0x57bc,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c01:	a1 a0 62 00 00       	mov    0x62a0,%eax
{
  ...
  freep = p;
    3c3f:	a3 a0 62 00 00       	mov    %eax,0x62a0
}
    3c44:	5b                   	pop    %ebx
    3c45:	5e                   	pop    %esi
    3c46:	5f                   	pop    %edi
    ...
    3c56:	72 ce                	jb     3c26 <free+0x26>
{
  ...
  freep = p;
    3c7a:	a3 a0 62 00 00       	mov    %eax,0x62a0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c9c:	8b 15 a0 62 00 00    	mov    0x62a0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3ce1:	39 05 a0 62 00 00    	cmp    %eax,0x62a0
  ...
  return freep;
    3d0b:	8b 15 a0 62 00 00    	mov    0x62a0,%edx
    ...
    3d34:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3d37:	89 15 a0 62 00 00    	mov    %edx,0x62a0
}
    ...
    base.s.ptr = freep = prevp = &base;
    3d50:	c7 05 a0 62 00 00 a4 	movl   $0x62a4,0x62a0
    3d57:	62 00 00 
    3d5a:	c7 05 a4 62 00 00 a4 	movl   $0x62a4,0x62a4
    3d61:	62 00 00 
    base.s.size = 0;
    3d64:	b8 a4 62 00 00       	mov    $0x62a4,%eax
    3d69:	c7 05 a8 62 00 00 00 	movl   $0x0,0x62a8
    3d70:	00 00 00 
...
int ourpower(int num) {
    ...
    for (int i = 0; i < num; i++)
    3d95:	7e 19                	jle    3db0 <ourpower.part.0+0x20>
    3d97:	31 d2                	xor    %edx,%edx
    int output = 1;
    3d99:	b9 01 00 00 00       	mov    $0x1,%ecx
    3d9e:	66 90                	xchg   %ax,%ax
    for (int i = 0; i < num; i++)
    3da0:	83 c2 01             	add    $0x1,%edx
        output *= 2;
    3da3:	01 c9                	add    %ecx,%ecx
    for (int i = 0; i < num; i++)
    3da5:	39 c2                	cmp    %eax,%edx
    3da7:	75 f7                	jne    3da0 <ourpower.part.0+0x10>
    return output;
}
    3da9:	89 c8                	mov    %ecx,%eax
    3dab:	5d                   	pop    %ebp
    3dac:	c3                   	ret    
    3dad:	8d 76 00             	lea    0x0(%esi),%esi
    int output = 1;
    3db0:	b9 01 00 00 00       	mov    $0x1,%ecx
}
    3db5:	89 c8                	mov    %ecx,%eax
    3db7:	5d                   	pop    %ebp
    3db8:	c3                   	ret    
...
int ourpower(int num) {
    ...
    3dc8:	78 03                	js     3dcd <ourpower+0xd>
}
    3dca:	5d                   	pop    %ebp
    3dcb:	eb c3                	jmp    3d90 <ourpower.part.0>
    3dcd:	83 c8 ff             	or     $0xffffffff,%eax
    3dd0:	5d                   	pop    %ebp
    3dd1:	c3                   	ret    
    3dd2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3dd9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00003de0 <trnmnt_tree_alloc>:
...
trnmnt_tree_alloc(int depth){
    ...
    3de6:	bb 00 aa 00 00       	mov    $0xaa00,%ebx
trnmnt_tree_alloc(int depth){
    3deb:	83 ec 0c             	sub    $0xc,%esp
    3dee:	8b 45 08             	mov    0x8(%ebp),%eax
    3df1:	eb 13                	jmp    3e06 <trnmnt_tree_alloc+0x26>
    3df3:	90                   	nop
    3df4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (t = treetable.trnmnt_tree ; t < &treetable.trnmnt_tree[NPROC] ; t++) {
    3df8:	81 c3 08 01 00 00    	add    $0x108,%ebx
    3dfe:	81 fb 00 ec 00 00    	cmp    $0xec00,%ebx
    3e04:	73 42                	jae    3e48 <trnmnt_tree_alloc+0x68>
        if (t->active == INACTIVE)
    3e06:	8b 13                	mov    (%ebx),%edx
    3e08:	85 d2                	test   %edx,%edx
    3e0a:	75 ec                	jne    3df8 <trnmnt_tree_alloc+0x18>
    if (num < 0) {
    3e0c:	85 c0                	test   %eax,%eax
            goto found_tree;
    }
    return 0;
    ...
    found_tree:
    t->active = ACTIVE;
    3e0e:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
    t->depth = depth;
    3e14:	89 43 04             	mov    %eax,0x4(%ebx)
    if (num < 0) {
    3e17:	78 1f                	js     3e38 <trnmnt_tree_alloc+0x58>
    3e19:	e8 72 ff ff ff       	call   3d90 <ourpower.part.0>

    for(int i=0; i<(ourpower(depth)-1); i++)
    3e1e:	31 f6                	xor    %esi,%esi
    3e20:	8d 78 ff             	lea    -0x1(%eax),%edi
    3e23:	eb 0f                	jmp    3e34 <trnmnt_tree_alloc+0x54>
    3e25:	8d 76 00             	lea    0x0(%esi),%esi
        t->trnmntMutex[i] = kthread_mutex_alloc();
    3e28:	e8 35 fb ff ff       	call   3962 <kthread_mutex_alloc>
    3e2d:	89 44 b3 08          	mov    %eax,0x8(%ebx,%esi,4)
    for(int i=0; i<(ourpower(depth)-1); i++)
    3e31:	83 c6 01             	add    $0x1,%esi
    3e34:	39 f7                	cmp    %esi,%edi
    3e36:	7f f0                	jg     3e28 <trnmnt_tree_alloc+0x48>

    return t;
}
    3e38:	83 c4 0c             	add    $0xc,%esp
    ...
    3e48:	83 c4 0c             	add    $0xc,%esp
    return 0;
    3e4b:	31 db                	xor    %ebx,%ebx
}
    3e4d:	89 d8                	mov    %ebx,%eax
    3e4f:	5b                   	pop    %ebx
    3e50:	5e                   	pop    %esi
    3e51:	5f                   	pop    %edi
    3e52:	5d                   	pop    %ebp
    3e53:	c3                   	ret    
    3e54:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    3e5a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

00003e60 <trnmnt_tree_dealloc>:
...
trnmnt_tree_dealloc(trnmnt_tree* tree){
    ...
    3e69:	8b 75 08             	mov    0x8(%ebp),%esi
    if(tree->active == INACTIVE )
    3e6c:	8b 06                	mov    (%esi),%eax
    3e6e:	85 c0                	test   %eax,%eax
    3e70:	74 56                	je     3ec8 <trnmnt_tree_dealloc+0x68>
        return -1;



    for(int j=0; j<(ourpower(tree->depth)-1); j++){
    3e72:	31 ff                	xor    %edi,%edi
    3e74:	eb 2e                	jmp    3ea4 <trnmnt_tree_dealloc+0x44>
    3e76:	8d 76 00             	lea    0x0(%esi),%esi
    3e79:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    3e80:	89 d8                	mov    %ebx,%eax
    3e82:	e8 09 ff ff ff       	call   3d90 <ourpower.part.0>
    3e87:	83 e8 01             	sub    $0x1,%eax
    3e8a:	39 c7                	cmp    %eax,%edi
    3e8c:	7d 47                	jge    3ed5 <trnmnt_tree_dealloc+0x75>
        if(safe_tree_dealloc(tree->trnmntMutex[j]) == 0 )
    3e8e:	83 ec 0c             	sub    $0xc,%esp
    3e91:	ff 74 be 08          	pushl  0x8(%esi,%edi,4)
    3e95:	e8 e8 fa ff ff       	call   3982 <safe_tree_dealloc>
    3e9a:	83 c4 10             	add    $0x10,%esp
    3e9d:	85 c0                	test   %eax,%eax
    3e9f:	74 27                	je     3ec8 <trnmnt_tree_dealloc+0x68>
    for(int j=0; j<(ourpower(tree->depth)-1); j++){
    3ea1:	83 c7 01             	add    $0x1,%edi
    3ea4:	8b 5e 04             	mov    0x4(%esi),%ebx
    if (num < 0) {
    3ea7:	85 db                	test   %ebx,%ebx
    3ea9:	79 d5                	jns    3e80 <trnmnt_tree_dealloc+0x20>
    ...
    tree->depth=0;
    3eab:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
    tree->active = INACTIVE;
    3eb2:	c7 06 00 00 00 00    	movl   $0x0,(%esi)

    return 0;
}
    3eb8:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
    3ebb:	31 c0                	xor    %eax,%eax
}
    3ebd:	5b                   	pop    %ebx
    3ebe:	5e                   	pop    %esi
    3ebf:	5f                   	pop    %edi
    ...
    3ec8:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return -1;
    3ecb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    3ed0:	5b                   	pop    %ebx
    3ed1:	5e                   	pop    %esi
    3ed2:	5f                   	pop    %edi
    ...
    3ed5:	31 ff                	xor    %edi,%edi
    3ed7:	89 f6                	mov    %esi,%esi
    3ed9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    3ee0:	89 d8                	mov    %ebx,%eax
    3ee2:	e8 a9 fe ff ff       	call   3d90 <ourpower.part.0>
    3ee7:	83 e8 01             	sub    $0x1,%eax
    3eea:	39 f8                	cmp    %edi,%eax
    3eec:	7e bd                	jle    3eab <trnmnt_tree_dealloc+0x4b>
        if(kthread_mutex_dealloc(tree->trnmntMutex[i]) == -1 ){
    3eee:	83 ec 0c             	sub    $0xc,%esp
    3ef1:	ff 74 be 08          	pushl  0x8(%esi,%edi,4)
    3ef5:	e8 70 fa ff ff       	call   396a <kthread_mutex_dealloc>
    3efa:	83 c4 10             	add    $0x10,%esp
    3efd:	83 f8 ff             	cmp    $0xffffffff,%eax
    3f00:	74 c6                	je     3ec8 <trnmnt_tree_dealloc+0x68>
    for(int i=0; i<(ourpower(tree->depth)-1); i++){
    3f02:	8b 5e 04             	mov    0x4(%esi),%ebx
    3f05:	83 c7 01             	add    $0x1,%edi
    if (num < 0) {
    3f08:	85 db                	test   %ebx,%ebx
    3f0a:	79 d4                	jns    3ee0 <trnmnt_tree_dealloc+0x80>
    3f0c:	eb 9d                	jmp    3eab <trnmnt_tree_dealloc+0x4b>
    3f0e:	66 90                	xchg   %ax,%ax

00003f10 <trnmnt_tree_acquire>:
...
trnmnt_tree_acquire(trnmnt_tree* tree,int ID){
    ...
    3f19:	8b 75 08             	mov    0x8(%ebp),%esi
    3f1c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    int x=0, localID=ID;
    for(int lvl=1; lvl<=tree->depth; lvl++){
    3f1f:	8b 46 04             	mov    0x4(%esi),%eax
    3f22:	85 c0                	test   %eax,%eax
    3f24:	7e 62                	jle    3f88 <trnmnt_tree_acquire+0x78>
    3f26:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
    int x=0, localID=ID;
    3f2d:	31 ff                	xor    %edi,%edi
    3f2f:	90                   	nop
        localID= localID/2;     //wich lock try to lock in current level
    3f30:	89 d8                	mov    %ebx,%eax
        if(kthread_mutex_lock(tree->trnmntMutex[x+localID]) == -1)
    3f32:	83 ec 0c             	sub    $0xc,%esp
        localID= localID/2;     //wich lock try to lock in current level
    3f35:	c1 e8 1f             	shr    $0x1f,%eax
    3f38:	01 c3                	add    %eax,%ebx
    3f3a:	d1 fb                	sar    %ebx
        if(kthread_mutex_lock(tree->trnmntMutex[x+localID]) == -1)
    3f3c:	8d 04 3b             	lea    (%ebx,%edi,1),%eax
    3f3f:	ff 74 86 08          	pushl  0x8(%esi,%eax,4)
    3f43:	e8 2a fa ff ff       	call   3972 <kthread_mutex_lock>
    3f48:	83 c4 10             	add    $0x10,%esp
    3f4b:	83 f8 ff             	cmp    $0xffffffff,%eax
    3f4e:	74 3a                	je     3f8a <trnmnt_tree_acquire+0x7a>
    ...
    3f50:	8b 4e 04             	mov    0x4(%esi),%ecx
    if (num < 0) {
    3f53:	85 c9                	test   %ecx,%ecx
    3f55:	78 31                	js     3f88 <trnmnt_tree_acquire+0x78>
    3f57:	89 c8                	mov    %ecx,%eax
    3f59:	89 4d dc             	mov    %ecx,-0x24(%ebp)
    3f5c:	e8 2f fe ff ff       	call   3d90 <ourpower.part.0>
    3f61:	89 45 e0             	mov    %eax,-0x20(%ebp)
    3f64:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f67:	e8 24 fe ff ff       	call   3d90 <ourpower.part.0>
    3f6c:	89 c1                	mov    %eax,%ecx
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
    3f6e:	8b 45 e0             	mov    -0x20(%ebp),%eax
    for(int lvl=1; lvl<=tree->depth; lvl++){
    3f71:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
    3f75:	99                   	cltd   
    3f76:	f7 f9                	idiv   %ecx
    for(int lvl=1; lvl<=tree->depth; lvl++){
    3f78:	8b 4d dc             	mov    -0x24(%ebp),%ecx
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
    3f7b:	01 c7                	add    %eax,%edi
    for(int lvl=1; lvl<=tree->depth; lvl++){
    3f7d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f80:	39 c1                	cmp    %eax,%ecx
    3f82:	7d ac                	jge    3f30 <trnmnt_tree_acquire+0x20>
    3f84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    }
    return 0;
    3f88:	31 c0                	xor    %eax,%eax
}
    3f8a:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3f8d:	5b                   	pop    %ebx
    3f8e:	5e                   	pop    %esi
    3f8f:	5f                   	pop    %edi
    3f90:	5d                   	pop    %ebp
    3f91:	c3                   	ret    
    3f92:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3f99:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00003fa0 <trnmnt_tree_release>:
...
trnmnt_tree_release(trnmnt_tree* tree,int ID){
    ...
    3fa9:	8b 7d 08             	mov    0x8(%ebp),%edi
    int x=ourpower(tree->depth)-2, localID;
    3fac:	8b 5f 04             	mov    0x4(%edi),%ebx
    if (num < 0) {
    3faf:	85 db                	test   %ebx,%ebx
    3fb1:	78 65                	js     4018 <trnmnt_tree_release+0x78>
    3fb3:	89 d8                	mov    %ebx,%eax
    3fb5:	e8 d6 fd ff ff       	call   3d90 <ourpower.part.0>
    for(int lvl=tree->depth; lvl>=1; lvl--){
    3fba:	85 db                	test   %ebx,%ebx
    3fbc:	8d 70 fe             	lea    -0x2(%eax),%esi
    3fbf:	7f 24                	jg     3fe5 <trnmnt_tree_release+0x45>
    3fc1:	eb 55                	jmp    4018 <trnmnt_tree_release+0x78>
    3fc3:	90                   	nop
    ...
    3fc8:	8b 57 04             	mov    0x4(%edi),%edx
        return -1;
    3fcb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
        x -= ourpower(tree->depth-lvl+1); //move x to point to the next level for localID
    3fd0:	29 da                	sub    %ebx,%edx
    if (num < 0) {
    3fd2:	83 c2 01             	add    $0x1,%edx
    3fd5:	78 07                	js     3fde <trnmnt_tree_release+0x3e>
    3fd7:	89 d0                	mov    %edx,%eax
    3fd9:	e8 b2 fd ff ff       	call   3d90 <ourpower.part.0>
        x -= ourpower(tree->depth-lvl+1); //move x to point to the next level for localID
    3fde:	29 c6                	sub    %eax,%esi
    for(int lvl=tree->depth; lvl>=1; lvl--){
    3fe0:	83 eb 01             	sub    $0x1,%ebx
    3fe3:	74 33                	je     4018 <trnmnt_tree_release+0x78>
    3fe5:	89 d8                	mov    %ebx,%eax
    3fe7:	e8 a4 fd ff ff       	call   3d90 <ourpower.part.0>
    3fec:	89 c1                	mov    %eax,%ecx
        localID= ID/ourpower(lvl);     //wich lock try to lock in current level
    ...
    3ff5:	f7 f9                	idiv   %ecx
        if(kthread_mutex_unlock(tree->trnmntMutex[x+localID]) == -1)
    3ff7:	01 f0                	add    %esi,%eax
    3ff9:	ff 74 87 08          	pushl  0x8(%edi,%eax,4)
    3ffd:	e8 78 f9 ff ff       	call   397a <kthread_mutex_unlock>
    4002:	83 c4 10             	add    $0x10,%esp
    4005:	83 f8 ff             	cmp    $0xffffffff,%eax
    4008:	75 be                	jne    3fc8 <trnmnt_tree_release+0x28>
    }
    return 0;
}
    400a:	8d 65 f4             	lea    -0xc(%ebp),%esp
    400d:	5b                   	pop    %ebx
    400e:	5e                   	pop    %esi
    400f:	5f                   	pop    %edi
    4010:	5d                   	pop    %ebp
    ...
    4018:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
    401b:	31 c0                	xor    %eax,%eax
}
    401d:	5b                   	pop    %ebx
    401e:	5e                   	pop    %esi
    401f:	5f                   	pop    %edi
