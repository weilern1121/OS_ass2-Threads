 ...
 489:	85 d2                	test   %edx,%edx
{
 ...
 4b7:	f7 f1                	div    %ecx
 4b9:	0f b6 92 40 0b 00 00 	movzbl 0xb40(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6d4:	e9 8f fe ff ff       	jmp    568 <printf+0x48>
          s = "(null)";
 6d9:	bb 37 0b 00 00       	mov    $0xb37,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 40 0f 00 00       	mov    0xf40,%eax
{
 ...
 72d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 72f:	a3 40 0f 00 00       	mov    %eax,0xf40
}
 734:	5b                   	pop    %ebx
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 40 0f 00 00       	mov    %eax,0xf40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 15 40 0f 00 00    	mov    0xf40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 47                	jae    818 <malloc+0x98>
    ...
    if(p == freep)
 7d1:	39 05 40 0f 00 00    	cmp    %eax,0xf40
 ...
 7f6:	e8 f5 fe ff ff       	call   6f0 <free>
  return freep;
 7fb:	8b 15 40 0f 00 00    	mov    0xf40,%edx
 ...
 824:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 827:	89 15 40 0f 00 00    	mov    %edx,0xf40
}
 ...
 839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 40 0f 00 00 44 	movl   $0xf44,0xf40
 847:	0f 00 00 
 84a:	c7 05 44 0f 00 00 44 	movl   $0xf44,0xf44
 851:	0f 00 00 
    base.s.size = 0;
 854:	b8 44 0f 00 00       	mov    $0xf44,%eax
 859:	c7 05 48 0f 00 00 00 	movl   $0x0,0xf48
 860:	00 00 00 
...
int ourpower(int num) {
 883:	89 e5                	mov    %esp,%ebp
    for (int i = 0; i < num; i++)
 885:	7e 19                	jle    8a0 <ourpower.part.0+0x20>
 ...
 890:	83 c2 01             	add    $0x1,%edx
        output *= 2;
 893:	01 c9                	add    %ecx,%ecx
    for (int i = 0; i < num; i++)
 895:	39 c2                	cmp    %eax,%edx
 897:	75 f7                	jne    890 <ourpower.part.0+0x10>
    return output;
}
 899:	89 c8                	mov    %ecx,%eax
 89b:	5d                   	pop    %ebp
 89c:	c3                   	ret    
...
int ourpower(int num) {
 ...
 8b8:	78 03                	js     8bd <ourpower+0xd>
}
 8ba:	5d                   	pop    %ebp
 8bb:	eb c3                	jmp    880 <ourpower.part.0>
 8bd:	83 c8 ff             	or     $0xffffffff,%eax
 8c0:	5d                   	pop    %ebp
 8c1:	c3                   	ret    
 8c2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000008d0 <trnmnt_tree_alloc>:
...
trnmnt_tree_alloc(int depth){
 ...
 8d6:	bb 60 0f 00 00       	mov    $0xf60,%ebx
trnmnt_tree_alloc(int depth){
 8db:	83 ec 0c             	sub    $0xc,%esp
 8de:	8b 45 08             	mov    0x8(%ebp),%eax
 8e1:	eb 13                	jmp    8f6 <trnmnt_tree_alloc+0x26>
 8e3:	90                   	nop
 8e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (t = treetable.trnmnt_tree ; t < &treetable.trnmnt_tree[NPROC] ; t++) {
 8e8:	81 c3 08 01 00 00    	add    $0x108,%ebx
 8ee:	81 fb 60 51 00 00    	cmp    $0x5160,%ebx
 8f4:	73 42                	jae    938 <trnmnt_tree_alloc+0x68>
        if (t->active == INACTIVE)
 8f6:	8b 13                	mov    (%ebx),%edx
 8f8:	85 d2                	test   %edx,%edx
 8fa:	75 ec                	jne    8e8 <trnmnt_tree_alloc+0x18>
    if (num < 0) {
 8fc:	85 c0                	test   %eax,%eax
    ...
    found_tree:
    t->active = ACTIVE;
 8fe:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
    t->depth = depth;
 904:	89 43 04             	mov    %eax,0x4(%ebx)
    if (num < 0) {
 907:	78 1f                	js     928 <trnmnt_tree_alloc+0x58>
 909:	e8 72 ff ff ff       	call   880 <ourpower.part.0>

    for(int i=0; i<(ourpower(depth)-1); i++)
 90e:	31 f6                	xor    %esi,%esi
 910:	8d 78 ff             	lea    -0x1(%eax),%edi
 913:	eb 0f                	jmp    924 <trnmnt_tree_alloc+0x54>
 915:	8d 76 00             	lea    0x0(%esi),%esi
        t->trnmntMutex[i] = kthread_mutex_alloc();
 918:	e8 35 fb ff ff       	call   452 <kthread_mutex_alloc>
 91d:	89 44 b3 08          	mov    %eax,0x8(%ebx,%esi,4)
    for(int i=0; i<(ourpower(depth)-1); i++)
 921:	83 c6 01             	add    $0x1,%esi
 924:	39 f7                	cmp    %esi,%edi
 926:	7f f0                	jg     918 <trnmnt_tree_alloc+0x48>

    return t;
}
 928:	83 c4 0c             	add    $0xc,%esp
 ...
 938:	83 c4 0c             	add    $0xc,%esp
    return 0;
 93b:	31 db                	xor    %ebx,%ebx
}
 93d:	89 d8                	mov    %ebx,%eax
 93f:	5b                   	pop    %ebx
 940:	5e                   	pop    %esi
 941:	5f                   	pop    %edi
 942:	5d                   	pop    %ebp
...
trnmnt_tree_dealloc(trnmnt_tree* tree){
 ...
 95c:	8b 06                	mov    (%esi),%eax
 95e:	85 c0                	test   %eax,%eax
 960:	74 56                	je     9b8 <trnmnt_tree_dealloc+0x68>
        return -1;
 ...
 964:	eb 2e                	jmp    994 <trnmnt_tree_dealloc+0x44>
 966:	8d 76 00             	lea    0x0(%esi),%esi
 969:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 970:	89 d8                	mov    %ebx,%eax
 972:	e8 09 ff ff ff       	call   880 <ourpower.part.0>
 977:	83 e8 01             	sub    $0x1,%eax
 97a:	39 c7                	cmp    %eax,%edi
 97c:	7d 47                	jge    9c5 <trnmnt_tree_dealloc+0x75>
        if(safe_tree_dealloc(tree->trnmntMutex[j]) == 0 )
 97e:	83 ec 0c             	sub    $0xc,%esp
 981:	ff 74 be 08          	pushl  0x8(%esi,%edi,4)
 985:	e8 e8 fa ff ff       	call   472 <safe_tree_dealloc>
 98a:	83 c4 10             	add    $0x10,%esp
 98d:	85 c0                	test   %eax,%eax
 98f:	74 27                	je     9b8 <trnmnt_tree_dealloc+0x68>
    for(int j=0; j<(ourpower(tree->depth)-1); j++){
 991:	83 c7 01             	add    $0x1,%edi
 994:	8b 5e 04             	mov    0x4(%esi),%ebx
    if (num < 0) {
 997:	85 db                	test   %ebx,%ebx
 999:	79 d5                	jns    970 <trnmnt_tree_dealloc+0x20>
    ...
    tree->depth=0;
 99b:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
    tree->active = INACTIVE;
 9a2:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
 ...
 9d2:	e8 a9 fe ff ff       	call   880 <ourpower.part.0>
 9d7:	83 e8 01             	sub    $0x1,%eax
 9da:	39 f8                	cmp    %edi,%eax
 9dc:	7e bd                	jle    99b <trnmnt_tree_dealloc+0x4b>
        if(kthread_mutex_dealloc(tree->trnmntMutex[i]) == -1 ){
 9de:	83 ec 0c             	sub    $0xc,%esp
 9e1:	ff 74 be 08          	pushl  0x8(%esi,%edi,4)
 9e5:	e8 70 fa ff ff       	call   45a <kthread_mutex_dealloc>
 9ea:	83 c4 10             	add    $0x10,%esp
 9ed:	83 f8 ff             	cmp    $0xffffffff,%eax
 9f0:	74 c6                	je     9b8 <trnmnt_tree_dealloc+0x68>
    for(int i=0; i<(ourpower(tree->depth)-1); i++){
 9f2:	8b 5e 04             	mov    0x4(%esi),%ebx
 9f5:	83 c7 01             	add    $0x1,%edi
    if (num < 0) {
 9f8:	85 db                	test   %ebx,%ebx
 9fa:	79 d4                	jns    9d0 <trnmnt_tree_dealloc+0x80>
 9fc:	eb 9d                	jmp    99b <trnmnt_tree_dealloc+0x4b>
 9fe:	66 90                	xchg   %ax,%ax

00000a00 <trnmnt_tree_acquire>:
...
trnmnt_tree_acquire(trnmnt_tree* tree,int ID){
 ...
 a0c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    int x=0, localID=ID;
    for(int lvl=1; lvl<=tree->depth; lvl++){
 a0f:	8b 46 04             	mov    0x4(%esi),%eax
 a12:	85 c0                	test   %eax,%eax
 a14:	7e 62                	jle    a78 <trnmnt_tree_acquire+0x78>
 a16:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
    int x=0, localID=ID;
 ...
 a22:	83 ec 0c             	sub    $0xc,%esp
        localID= localID/2;     //wich lock try to lock in current level
 a25:	c1 e8 1f             	shr    $0x1f,%eax
 a28:	01 c3                	add    %eax,%ebx
 a2a:	d1 fb                	sar    %ebx
        if(kthread_mutex_lock(tree->trnmntMutex[x+localID]) == -1)
 a2c:	8d 04 3b             	lea    (%ebx,%edi,1),%eax
 a2f:	ff 74 86 08          	pushl  0x8(%esi,%eax,4)
 a33:	e8 2a fa ff ff       	call   462 <kthread_mutex_lock>
 a38:	83 c4 10             	add    $0x10,%esp
 a3b:	83 f8 ff             	cmp    $0xffffffff,%eax
 a3e:	74 3a                	je     a7a <trnmnt_tree_acquire+0x7a>
 ...
 a40:	8b 4e 04             	mov    0x4(%esi),%ecx
    if (num < 0) {
 a43:	85 c9                	test   %ecx,%ecx
 a45:	78 31                	js     a78 <trnmnt_tree_acquire+0x78>
 a47:	89 c8                	mov    %ecx,%eax
 a49:	89 4d dc             	mov    %ecx,-0x24(%ebp)
 a4c:	e8 2f fe ff ff       	call   880 <ourpower.part.0>
 a51:	89 45 e0             	mov    %eax,-0x20(%ebp)
 a54:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 a57:	e8 24 fe ff ff       	call   880 <ourpower.part.0>
 a5c:	89 c1                	mov    %eax,%ecx
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 a5e:	8b 45 e0             	mov    -0x20(%ebp),%eax
    for(int lvl=1; lvl<=tree->depth; lvl++){
 a61:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 a65:	99                   	cltd   
 a66:	f7 f9                	idiv   %ecx
    for(int lvl=1; lvl<=tree->depth; lvl++){
 a68:	8b 4d dc             	mov    -0x24(%ebp),%ecx
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 a6b:	01 c7                	add    %eax,%edi
    for(int lvl=1; lvl<=tree->depth; lvl++){
 a6d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 a70:	39 c1                	cmp    %eax,%ecx
 a72:	7d ac                	jge    a20 <trnmnt_tree_acquire+0x20>
 ...
 a80:	5d                   	pop    %ebp
 a81:	c3                   	ret    
 a82:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 a89:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000a90 <trnmnt_tree_release>:
...
trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 a9c:	8b 5f 04             	mov    0x4(%edi),%ebx
    if (num < 0) {
 a9f:	85 db                	test   %ebx,%ebx
 aa1:	78 65                	js     b08 <trnmnt_tree_release+0x78>
 aa3:	89 d8                	mov    %ebx,%eax
 aa5:	e8 d6 fd ff ff       	call   880 <ourpower.part.0>
    for(int lvl=tree->depth; lvl>=1; lvl--){
 aaa:	85 db                	test   %ebx,%ebx
 aac:	8d 70 fe             	lea    -0x2(%eax),%esi
 aaf:	7f 24                	jg     ad5 <trnmnt_tree_release+0x45>
 ab1:	eb 55                	jmp    b08 <trnmnt_tree_release+0x78>
 ab3:	90                   	nop
 ...
 ab8:	8b 57 04             	mov    0x4(%edi),%edx
        return -1;
 abb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
        x -= ourpower(tree->depth-lvl+1); //move x to point to the next level for localID
 ac0:	29 da                	sub    %ebx,%edx
    if (num < 0) {
 ac2:	83 c2 01             	add    $0x1,%edx
 ac5:	78 07                	js     ace <trnmnt_tree_release+0x3e>
 ac7:	89 d0                	mov    %edx,%eax
 ac9:	e8 b2 fd ff ff       	call   880 <ourpower.part.0>
        x -= ourpower(tree->depth-lvl+1); //move x to point to the next level for localID
 ace:	29 c6                	sub    %eax,%esi
    for(int lvl=tree->depth; lvl>=1; lvl--){
 ad0:	83 eb 01             	sub    $0x1,%ebx
 ad3:	74 33                	je     b08 <trnmnt_tree_release+0x78>
 ad5:	89 d8                	mov    %ebx,%eax
 ad7:	e8 a4 fd ff ff       	call   880 <ourpower.part.0>
 ...
 ae5:	f7 f9                	idiv   %ecx
        if(kthread_mutex_unlock(tree->trnmntMutex[x+localID]) == -1)
 ae7:	01 f0                	add    %esi,%eax
 ae9:	ff 74 87 08          	pushl  0x8(%edi,%eax,4)
 aed:	e8 78 f9 ff ff       	call   46a <kthread_mutex_unlock>
 af2:	83 c4 10             	add    $0x10,%esp
 af5:	83 f8 ff             	cmp    $0xffffffff,%eax
 af8:	75 be                	jne    ab8 <trnmnt_tree_release+0x28>
    }
    return 0;
}
