 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 0c 0a 00 00 	movzbl 0xa0c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 04 0a 00 00       	mov    $0xa04,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 00 0e 00 00       	mov    0xe00,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 00 0e 00 00       	mov    %eax,0xe00
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 00 0e 00 00       	mov    %eax,0xe00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 00 0e 00 00    	mov    0xe00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 47                	jae    708 <malloc+0x98>
    ...
    if(p == freep)
 6c1:	39 05 00 0e 00 00    	cmp    %eax,0xe00
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
  return freep;
 6eb:	8b 15 00 0e 00 00    	mov    0xe00,%edx
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 717:	89 15 00 0e 00 00    	mov    %edx,0xe00
}
 ...
 729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 00 0e 00 00 04 	movl   $0xe04,0xe00
 737:	0e 00 00 
 73a:	c7 05 04 0e 00 00 04 	movl   $0xe04,0xe04
 741:	0e 00 00 
    base.s.size = 0;
 744:	b8 04 0e 00 00       	mov    $0xe04,%eax
 749:	c7 05 08 0e 00 00 00 	movl   $0x0,0xe08
 750:	00 00 00 
...
int ourpower(int num) {
 773:	89 e5                	mov    %esp,%ebp
    for (int i = 0; i < num; i++)
 775:	7e 19                	jle    790 <ourpower.part.0+0x20>
 777:	31 d2                	xor    %edx,%edx
    int output = 1;
 779:	b9 01 00 00 00       	mov    $0x1,%ecx
 77e:	66 90                	xchg   %ax,%ax
    for (int i = 0; i < num; i++)
 780:	83 c2 01             	add    $0x1,%edx
        output *= 2;
 783:	01 c9                	add    %ecx,%ecx
    for (int i = 0; i < num; i++)
 785:	39 c2                	cmp    %eax,%edx
 787:	75 f7                	jne    780 <ourpower.part.0+0x10>
    return output;
}
 ...
 78d:	8d 76 00             	lea    0x0(%esi),%esi
    int output = 1;
 790:	b9 01 00 00 00       	mov    $0x1,%ecx
}
...
int ourpower(int num) {
 ...
 7a8:	78 03                	js     7ad <ourpower+0xd>
}
 7aa:	5d                   	pop    %ebp
 7ab:	eb c3                	jmp    770 <ourpower.part.0>
 7ad:	83 c8 ff             	or     $0xffffffff,%eax
 7b0:	5d                   	pop    %ebp
 7b1:	c3                   	ret    
...
trnmnt_tree_alloc(int depth){
 ...
 7c6:	bb 20 0e 00 00       	mov    $0xe20,%ebx
trnmnt_tree_alloc(int depth){
 7cb:	83 ec 0c             	sub    $0xc,%esp
 7ce:	8b 45 08             	mov    0x8(%ebp),%eax
 7d1:	eb 13                	jmp    7e6 <trnmnt_tree_alloc+0x26>
 7d3:	90                   	nop
 7d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (t = treetable.trnmnt_tree ; t < &treetable.trnmnt_tree[NPROC] ; t++) {
 7d8:	81 c3 08 01 00 00    	add    $0x108,%ebx
 7de:	81 fb 20 50 00 00    	cmp    $0x5020,%ebx
 7e4:	73 42                	jae    828 <trnmnt_tree_alloc+0x68>
        if (t->active == INACTIVE)
 7e6:	8b 13                	mov    (%ebx),%edx
 7e8:	85 d2                	test   %edx,%edx
 7ea:	75 ec                	jne    7d8 <trnmnt_tree_alloc+0x18>
    if (num < 0) {
 ...
 7ee:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
    t->depth = depth;
 7f4:	89 43 04             	mov    %eax,0x4(%ebx)
    if (num < 0) {
 7f7:	78 1f                	js     818 <trnmnt_tree_alloc+0x58>
 7f9:	e8 72 ff ff ff       	call   770 <ourpower.part.0>

    for(int i=0; i<(ourpower(depth)-1); i++)
 7fe:	31 f6                	xor    %esi,%esi
 800:	8d 78 ff             	lea    -0x1(%eax),%edi
 803:	eb 0f                	jmp    814 <trnmnt_tree_alloc+0x54>
 805:	8d 76 00             	lea    0x0(%esi),%esi
        t->trnmntMutex[i] = kthread_mutex_alloc();
 808:	e8 35 fb ff ff       	call   342 <kthread_mutex_alloc>
 80d:	89 44 b3 08          	mov    %eax,0x8(%ebx,%esi,4)
    for(int i=0; i<(ourpower(depth)-1); i++)
 811:	83 c6 01             	add    $0x1,%esi
 814:	39 f7                	cmp    %esi,%edi
 816:	7f f0                	jg     808 <trnmnt_tree_alloc+0x48>
...
trnmnt_tree_dealloc(trnmnt_tree* tree){
 ...
 84c:	8b 06                	mov    (%esi),%eax
 84e:	85 c0                	test   %eax,%eax
 850:	74 56                	je     8a8 <trnmnt_tree_dealloc+0x68>
        return -1;
 ...
 854:	eb 2e                	jmp    884 <trnmnt_tree_dealloc+0x44>
 856:	8d 76 00             	lea    0x0(%esi),%esi
 859:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 860:	89 d8                	mov    %ebx,%eax
 862:	e8 09 ff ff ff       	call   770 <ourpower.part.0>
 867:	83 e8 01             	sub    $0x1,%eax
 86a:	39 c7                	cmp    %eax,%edi
 86c:	7d 47                	jge    8b5 <trnmnt_tree_dealloc+0x75>
        if(safe_tree_dealloc(tree->trnmntMutex[j]) == 0 )
 86e:	83 ec 0c             	sub    $0xc,%esp
 871:	ff 74 be 08          	pushl  0x8(%esi,%edi,4)
 875:	e8 e8 fa ff ff       	call   362 <safe_tree_dealloc>
 87a:	83 c4 10             	add    $0x10,%esp
 87d:	85 c0                	test   %eax,%eax
 87f:	74 27                	je     8a8 <trnmnt_tree_dealloc+0x68>
    for(int j=0; j<(ourpower(tree->depth)-1); j++){
 881:	83 c7 01             	add    $0x1,%edi
 884:	8b 5e 04             	mov    0x4(%esi),%ebx
    if (num < 0) {
 887:	85 db                	test   %ebx,%ebx
 889:	79 d5                	jns    860 <trnmnt_tree_dealloc+0x20>
    ...
    tree->depth=0;
 88b:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
    tree->active = INACTIVE;
 892:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
 ...
 8b5:	31 ff                	xor    %edi,%edi
 8b7:	89 f6                	mov    %esi,%esi
 8b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 8c0:	89 d8                	mov    %ebx,%eax
 8c2:	e8 a9 fe ff ff       	call   770 <ourpower.part.0>
 8c7:	83 e8 01             	sub    $0x1,%eax
 8ca:	39 f8                	cmp    %edi,%eax
 8cc:	7e bd                	jle    88b <trnmnt_tree_dealloc+0x4b>
        if(kthread_mutex_dealloc(tree->trnmntMutex[i]) == -1 ){
 8ce:	83 ec 0c             	sub    $0xc,%esp
 8d1:	ff 74 be 08          	pushl  0x8(%esi,%edi,4)
 8d5:	e8 70 fa ff ff       	call   34a <kthread_mutex_dealloc>
 8da:	83 c4 10             	add    $0x10,%esp
 8dd:	83 f8 ff             	cmp    $0xffffffff,%eax
 8e0:	74 c6                	je     8a8 <trnmnt_tree_dealloc+0x68>
    for(int i=0; i<(ourpower(tree->depth)-1); i++){
 8e2:	8b 5e 04             	mov    0x4(%esi),%ebx
 8e5:	83 c7 01             	add    $0x1,%edi
    if (num < 0) {
 8e8:	85 db                	test   %ebx,%ebx
 8ea:	79 d4                	jns    8c0 <trnmnt_tree_dealloc+0x80>
 8ec:	eb 9d                	jmp    88b <trnmnt_tree_dealloc+0x4b>
 8ee:	66 90                	xchg   %ax,%ax

000008f0 <trnmnt_tree_acquire>:
...
trnmnt_tree_acquire(trnmnt_tree* tree,int ID){
 ...
 8fc:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    int x=0, localID=ID;
    for(int lvl=1; lvl<=tree->depth; lvl++){
 8ff:	8b 46 04             	mov    0x4(%esi),%eax
 902:	85 c0                	test   %eax,%eax
 904:	7e 62                	jle    968 <trnmnt_tree_acquire+0x78>
 906:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
    int x=0, localID=ID;
 ...
 912:	83 ec 0c             	sub    $0xc,%esp
        localID= localID/2;     //wich lock try to lock in current level
 915:	c1 e8 1f             	shr    $0x1f,%eax
 918:	01 c3                	add    %eax,%ebx
 91a:	d1 fb                	sar    %ebx
        if(kthread_mutex_lock(tree->trnmntMutex[x+localID]) == -1)
 91c:	8d 04 3b             	lea    (%ebx,%edi,1),%eax
 91f:	ff 74 86 08          	pushl  0x8(%esi,%eax,4)
 923:	e8 2a fa ff ff       	call   352 <kthread_mutex_lock>
 928:	83 c4 10             	add    $0x10,%esp
 92b:	83 f8 ff             	cmp    $0xffffffff,%eax
 92e:	74 3a                	je     96a <trnmnt_tree_acquire+0x7a>
 ...
 930:	8b 4e 04             	mov    0x4(%esi),%ecx
    if (num < 0) {
 933:	85 c9                	test   %ecx,%ecx
 935:	78 31                	js     968 <trnmnt_tree_acquire+0x78>
 937:	89 c8                	mov    %ecx,%eax
 939:	89 4d dc             	mov    %ecx,-0x24(%ebp)
 93c:	e8 2f fe ff ff       	call   770 <ourpower.part.0>
 941:	89 45 e0             	mov    %eax,-0x20(%ebp)
 944:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 947:	e8 24 fe ff ff       	call   770 <ourpower.part.0>
 94c:	89 c1                	mov    %eax,%ecx
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 94e:	8b 45 e0             	mov    -0x20(%ebp),%eax
    for(int lvl=1; lvl<=tree->depth; lvl++){
 951:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 955:	99                   	cltd   
 956:	f7 f9                	idiv   %ecx
    for(int lvl=1; lvl<=tree->depth; lvl++){
 958:	8b 4d dc             	mov    -0x24(%ebp),%ecx
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 95b:	01 c7                	add    %eax,%edi
    for(int lvl=1; lvl<=tree->depth; lvl++){
 95d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 960:	39 c1                	cmp    %eax,%ecx
 962:	7d ac                	jge    910 <trnmnt_tree_acquire+0x20>
...
trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 98c:	8b 5f 04             	mov    0x4(%edi),%ebx
    if (num < 0) {
 98f:	85 db                	test   %ebx,%ebx
 991:	78 65                	js     9f8 <trnmnt_tree_release+0x78>
 993:	89 d8                	mov    %ebx,%eax
 995:	e8 d6 fd ff ff       	call   770 <ourpower.part.0>
    for(int lvl=tree->depth; lvl>=1; lvl--){
 99a:	85 db                	test   %ebx,%ebx
 99c:	8d 70 fe             	lea    -0x2(%eax),%esi
 99f:	7f 24                	jg     9c5 <trnmnt_tree_release+0x45>
 9a1:	eb 55                	jmp    9f8 <trnmnt_tree_release+0x78>
 9a3:	90                   	nop
 ...
 9a8:	8b 57 04             	mov    0x4(%edi),%edx
        return -1;
 9ab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
        x -= ourpower(tree->depth-lvl+1); //move x to point to the next level for localID
 9b0:	29 da                	sub    %ebx,%edx
    if (num < 0) {
 9b2:	83 c2 01             	add    $0x1,%edx
 9b5:	78 07                	js     9be <trnmnt_tree_release+0x3e>
 9b7:	89 d0                	mov    %edx,%eax
 9b9:	e8 b2 fd ff ff       	call   770 <ourpower.part.0>
        x -= ourpower(tree->depth-lvl+1); //move x to point to the next level for localID
 9be:	29 c6                	sub    %eax,%esi
    for(int lvl=tree->depth; lvl>=1; lvl--){
 9c0:	83 eb 01             	sub    $0x1,%ebx
 9c3:	74 33                	je     9f8 <trnmnt_tree_release+0x78>
 9c5:	89 d8                	mov    %ebx,%eax
 9c7:	e8 a4 fd ff ff       	call   770 <ourpower.part.0>
 9cc:	89 c1                	mov    %eax,%ecx
        localID= ID/ourpower(lvl);     //wich lock try to lock in current level
 ...
 9d5:	f7 f9                	idiv   %ecx
        if(kthread_mutex_unlock(tree->trnmntMutex[x+localID]) == -1)
 9d7:	01 f0                	add    %esi,%eax
 9d9:	ff 74 87 08          	pushl  0x8(%edi,%eax,4)
 9dd:	e8 78 f9 ff ff       	call   35a <kthread_mutex_unlock>
 9e2:	83 c4 10             	add    $0x10,%esp
 9e5:	83 f8 ff             	cmp    $0xffffffff,%eax
 9e8:	75 be                	jne    9a8 <trnmnt_tree_release+0x28>
    }
    return 0;
}
