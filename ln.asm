 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 64 0a 00 00 	movzbl 0xa64(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb 5b 0a 00 00       	mov    $0xa5b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 40 0e 00 00       	mov    0xe40,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 40 0e 00 00       	mov    %eax,0xe40
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 40 0e 00 00       	mov    %eax,0xe40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 40 0e 00 00    	mov    0xe40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 40 0e 00 00    	cmp    %eax,0xe40
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 40 0e 00 00    	mov    0xe40,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 40 0e 00 00    	mov    %edx,0xe40
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 40 0e 00 00 44 	movl   $0xe44,0xe40
 767:	0e 00 00 
 76a:	c7 05 44 0e 00 00 44 	movl   $0xe44,0xe44
 771:	0e 00 00 
    base.s.size = 0;
 774:	b8 44 0e 00 00       	mov    $0xe44,%eax
 779:	c7 05 48 0e 00 00 00 	movl   $0x0,0xe48
 780:	00 00 00 
...
int ourpower(int num) {
 7a3:	89 e5                	mov    %esp,%ebp
    for (int i = 0; i < num; i++)
 7a5:	7e 19                	jle    7c0 <ourpower.part.0+0x20>
 7a7:	31 d2                	xor    %edx,%edx
    int output = 1;
 7a9:	b9 01 00 00 00       	mov    $0x1,%ecx
 ...
 7b7:	75 f7                	jne    7b0 <ourpower.part.0+0x10>
    return output;
}
 7b9:	89 c8                	mov    %ecx,%eax
 7bb:	5d                   	pop    %ebp
 7bc:	c3                   	ret    
 7bd:	8d 76 00             	lea    0x0(%esi),%esi
    int output = 1;
 7c0:	b9 01 00 00 00       	mov    $0x1,%ecx
}
...
int ourpower(int num) {
 ...
 7d8:	78 03                	js     7dd <ourpower+0xd>
}
 7da:	5d                   	pop    %ebp
 7db:	eb c3                	jmp    7a0 <ourpower.part.0>
 7dd:	83 c8 ff             	or     $0xffffffff,%eax
 7e0:	5d                   	pop    %ebp
 7e1:	c3                   	ret    
 7e2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 7e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000007f0 <trnmnt_tree_alloc>:
...
trnmnt_tree_alloc(int depth){
 ...
 7f6:	bb 60 0e 00 00       	mov    $0xe60,%ebx
trnmnt_tree_alloc(int depth){
 7fb:	83 ec 0c             	sub    $0xc,%esp
 7fe:	8b 45 08             	mov    0x8(%ebp),%eax
 801:	eb 13                	jmp    816 <trnmnt_tree_alloc+0x26>
 803:	90                   	nop
 804:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (t = treetable.trnmnt_tree ; t < &treetable.trnmnt_tree[NPROC] ; t++) {
 808:	81 c3 08 01 00 00    	add    $0x108,%ebx
 80e:	81 fb 60 50 00 00    	cmp    $0x5060,%ebx
 814:	73 42                	jae    858 <trnmnt_tree_alloc+0x68>
        if (t->active == INACTIVE)
 816:	8b 13                	mov    (%ebx),%edx
 818:	85 d2                	test   %edx,%edx
 81a:	75 ec                	jne    808 <trnmnt_tree_alloc+0x18>
    if (num < 0) {
 81c:	85 c0                	test   %eax,%eax
    ...
    found_tree:
    t->active = ACTIVE;
 81e:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
    t->depth = depth;
 824:	89 43 04             	mov    %eax,0x4(%ebx)
    if (num < 0) {
 827:	78 1f                	js     848 <trnmnt_tree_alloc+0x58>
 829:	e8 72 ff ff ff       	call   7a0 <ourpower.part.0>

    for(int i=0; i<(ourpower(depth)-1); i++)
 82e:	31 f6                	xor    %esi,%esi
 830:	8d 78 ff             	lea    -0x1(%eax),%edi
 833:	eb 0f                	jmp    844 <trnmnt_tree_alloc+0x54>
 835:	8d 76 00             	lea    0x0(%esi),%esi
        t->trnmntMutex[i] = kthread_mutex_alloc();
 838:	e8 35 fb ff ff       	call   372 <kthread_mutex_alloc>
 83d:	89 44 b3 08          	mov    %eax,0x8(%ebx,%esi,4)
    for(int i=0; i<(ourpower(depth)-1); i++)
 841:	83 c6 01             	add    $0x1,%esi
 844:	39 f7                	cmp    %esi,%edi
 846:	7f f0                	jg     838 <trnmnt_tree_alloc+0x48>

    return t;
}
 848:	83 c4 0c             	add    $0xc,%esp
...
trnmnt_tree_dealloc(trnmnt_tree* tree){
 ...
 87c:	8b 06                	mov    (%esi),%eax
 87e:	85 c0                	test   %eax,%eax
 880:	74 56                	je     8d8 <trnmnt_tree_dealloc+0x68>
        return -1;
 ...
 884:	eb 2e                	jmp    8b4 <trnmnt_tree_dealloc+0x44>
 886:	8d 76 00             	lea    0x0(%esi),%esi
 889:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 890:	89 d8                	mov    %ebx,%eax
 892:	e8 09 ff ff ff       	call   7a0 <ourpower.part.0>
 897:	83 e8 01             	sub    $0x1,%eax
 89a:	39 c7                	cmp    %eax,%edi
 89c:	7d 47                	jge    8e5 <trnmnt_tree_dealloc+0x75>
        if(safe_tree_dealloc(tree->trnmntMutex[j]) == 0 )
 89e:	83 ec 0c             	sub    $0xc,%esp
 8a1:	ff 74 be 08          	pushl  0x8(%esi,%edi,4)
 8a5:	e8 e8 fa ff ff       	call   392 <safe_tree_dealloc>
 8aa:	83 c4 10             	add    $0x10,%esp
 8ad:	85 c0                	test   %eax,%eax
 8af:	74 27                	je     8d8 <trnmnt_tree_dealloc+0x68>
    for(int j=0; j<(ourpower(tree->depth)-1); j++){
 8b1:	83 c7 01             	add    $0x1,%edi
 8b4:	8b 5e 04             	mov    0x4(%esi),%ebx
    if (num < 0) {
 8b7:	85 db                	test   %ebx,%ebx
 8b9:	79 d5                	jns    890 <trnmnt_tree_dealloc+0x20>
    ...
    tree->depth=0;
 8bb:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
    tree->active = INACTIVE;
 8c2:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
 ...
 8f2:	e8 a9 fe ff ff       	call   7a0 <ourpower.part.0>
 8f7:	83 e8 01             	sub    $0x1,%eax
 8fa:	39 f8                	cmp    %edi,%eax
 8fc:	7e bd                	jle    8bb <trnmnt_tree_dealloc+0x4b>
        if(kthread_mutex_dealloc(tree->trnmntMutex[i]) == -1 ){
 8fe:	83 ec 0c             	sub    $0xc,%esp
 901:	ff 74 be 08          	pushl  0x8(%esi,%edi,4)
 905:	e8 70 fa ff ff       	call   37a <kthread_mutex_dealloc>
 90a:	83 c4 10             	add    $0x10,%esp
 90d:	83 f8 ff             	cmp    $0xffffffff,%eax
 910:	74 c6                	je     8d8 <trnmnt_tree_dealloc+0x68>
    for(int i=0; i<(ourpower(tree->depth)-1); i++){
 912:	8b 5e 04             	mov    0x4(%esi),%ebx
 915:	83 c7 01             	add    $0x1,%edi
    if (num < 0) {
 918:	85 db                	test   %ebx,%ebx
 91a:	79 d4                	jns    8f0 <trnmnt_tree_dealloc+0x80>
 91c:	eb 9d                	jmp    8bb <trnmnt_tree_dealloc+0x4b>
 91e:	66 90                	xchg   %ax,%ax

00000920 <trnmnt_tree_acquire>:
...
trnmnt_tree_acquire(trnmnt_tree* tree,int ID){
 ...
 92f:	8b 46 04             	mov    0x4(%esi),%eax
 932:	85 c0                	test   %eax,%eax
 934:	7e 62                	jle    998 <trnmnt_tree_acquire+0x78>
 936:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
    int x=0, localID=ID;
 ...
 942:	83 ec 0c             	sub    $0xc,%esp
        localID= localID/2;     //wich lock try to lock in current level
 945:	c1 e8 1f             	shr    $0x1f,%eax
 948:	01 c3                	add    %eax,%ebx
 94a:	d1 fb                	sar    %ebx
        if(kthread_mutex_lock(tree->trnmntMutex[x+localID]) == -1)
 94c:	8d 04 3b             	lea    (%ebx,%edi,1),%eax
 94f:	ff 74 86 08          	pushl  0x8(%esi,%eax,4)
 953:	e8 2a fa ff ff       	call   382 <kthread_mutex_lock>
 958:	83 c4 10             	add    $0x10,%esp
 95b:	83 f8 ff             	cmp    $0xffffffff,%eax
 95e:	74 3a                	je     99a <trnmnt_tree_acquire+0x7a>
 ...
 960:	8b 4e 04             	mov    0x4(%esi),%ecx
    if (num < 0) {
 963:	85 c9                	test   %ecx,%ecx
 965:	78 31                	js     998 <trnmnt_tree_acquire+0x78>
 967:	89 c8                	mov    %ecx,%eax
 969:	89 4d dc             	mov    %ecx,-0x24(%ebp)
 96c:	e8 2f fe ff ff       	call   7a0 <ourpower.part.0>
 971:	89 45 e0             	mov    %eax,-0x20(%ebp)
 974:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 977:	e8 24 fe ff ff       	call   7a0 <ourpower.part.0>
 97c:	89 c1                	mov    %eax,%ecx
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 97e:	8b 45 e0             	mov    -0x20(%ebp),%eax
    for(int lvl=1; lvl<=tree->depth; lvl++){
 981:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 985:	99                   	cltd   
 986:	f7 f9                	idiv   %ecx
    for(int lvl=1; lvl<=tree->depth; lvl++){
 988:	8b 4d dc             	mov    -0x24(%ebp),%ecx
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 98b:	01 c7                	add    %eax,%edi
    for(int lvl=1; lvl<=tree->depth; lvl++){
 98d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 990:	39 c1                	cmp    %eax,%ecx
 992:	7d ac                	jge    940 <trnmnt_tree_acquire+0x20>
...
trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 9bc:	8b 5f 04             	mov    0x4(%edi),%ebx
    if (num < 0) {
 9bf:	85 db                	test   %ebx,%ebx
 9c1:	78 65                	js     a28 <trnmnt_tree_release+0x78>
 9c3:	89 d8                	mov    %ebx,%eax
 9c5:	e8 d6 fd ff ff       	call   7a0 <ourpower.part.0>
    for(int lvl=tree->depth; lvl>=1; lvl--){
 9ca:	85 db                	test   %ebx,%ebx
 9cc:	8d 70 fe             	lea    -0x2(%eax),%esi
 9cf:	7f 24                	jg     9f5 <trnmnt_tree_release+0x45>
 9d1:	eb 55                	jmp    a28 <trnmnt_tree_release+0x78>
 9d3:	90                   	nop
 ...
 9d8:	8b 57 04             	mov    0x4(%edi),%edx
        return -1;
 9db:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
        x -= ourpower(tree->depth-lvl+1); //move x to point to the next level for localID
 9e0:	29 da                	sub    %ebx,%edx
    if (num < 0) {
 9e2:	83 c2 01             	add    $0x1,%edx
 9e5:	78 07                	js     9ee <trnmnt_tree_release+0x3e>
 9e7:	89 d0                	mov    %edx,%eax
 9e9:	e8 b2 fd ff ff       	call   7a0 <ourpower.part.0>
        x -= ourpower(tree->depth-lvl+1); //move x to point to the next level for localID
 9ee:	29 c6                	sub    %eax,%esi
    for(int lvl=tree->depth; lvl>=1; lvl--){
 9f0:	83 eb 01             	sub    $0x1,%ebx
 9f3:	74 33                	je     a28 <trnmnt_tree_release+0x78>
 9f5:	89 d8                	mov    %ebx,%eax
 9f7:	e8 a4 fd ff ff       	call   7a0 <ourpower.part.0>
 9fc:	89 c1                	mov    %eax,%ecx
        localID= ID/ourpower(lvl);     //wich lock try to lock in current level
 ...
 a05:	f7 f9                	idiv   %ecx
        if(kthread_mutex_unlock(tree->trnmntMutex[x+localID]) == -1)
 a07:	01 f0                	add    %esi,%eax
 a09:	ff 74 87 08          	pushl  0x8(%edi,%eax,4)
 a0d:	e8 78 f9 ff ff       	call   38a <kthread_mutex_unlock>
 a12:	83 c4 10             	add    $0x10,%esp
 a15:	83 f8 ff             	cmp    $0xffffffff,%eax
 a18:	75 be                	jne    9d8 <trnmnt_tree_release+0x28>
    }
    return 0;
}
