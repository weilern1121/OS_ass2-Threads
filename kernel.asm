...
8010123a:	e8 31 31 00 00       	call   80104370 <acquire>
...
801012ca:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012cd:	e8 5e 31 00 00       	call   80104430 <release>
      return ip;
...
801014a6:	e8 85 2d 00 00       	call   80104230 <initlock>
...
8010166f:	e8 fc 2c 00 00       	call   80104370 <acquire>
  ip->ref++;
...
801017f6:	e8 75 2b 00 00       	call   80104370 <acquire>
  ip->ref--;
...
80101820:	e8 4b 2b 00 00       	call   80104370 <acquire>
    int r = ip->ref;
...
80101c99:	e8 d2 26 00 00       	call   80104370 <acquire>
  ip->ref++;
80101c9e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101ca2:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101ca9:	e8 82 27 00 00       	call   80104430 <release>
...
80101ed8:	68 3e 76 10 80       	push   $0x8010763e
...
80102020:	e8 0b 22 00 00       	call   80104230 <initlock>
...
8010209e:	e8 cd 22 00 00       	call   80104370 <acquire>
...
8010211f:	e8 0c 23 00 00       	call   80104430 <release>
...
80102178:	e8 f3 21 00 00       	call   80104370 <acquire>
...
801021e5:	c9                   	leave  
  release(&idelock);
801021e6:	e9 45 22 00 00       	jmp    80104430 <release>
801021eb:	90                   	nop
...
80102332:	81 fb a8 65 11 80    	cmp    $0x801165a8,%ebx
...
8010238a:	c9                   	leave  
    release(&kmem.lock);
8010238b:	e9 a0 20 00 00       	jmp    80104430 <release>
    acquire(&kmem.lock);
80102390:	83 ec 0c             	sub    $0xc,%esp
80102393:	68 40 26 11 80       	push   $0x80112640
80102398:	e8 d3 1f 00 00       	call   80104370 <acquire>
...
80102415:	e8 16 1e 00 00       	call   80104230 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102503:	e8 68 1e 00 00       	call   80104370 <acquire>
  r = kmem.freelist;
...
80102531:	e8 fa 1e 00 00       	call   80104430 <release>
  return (char*)r;
...
80102bbb:	e8 b0 17 00 00       	call   80104370 <acquire>
...
80102c2e:	e8 3d 17 00 00       	call   80104370 <acquire>
  log.outstanding -= 1;
...
80102c6c:	e8 bf 17 00 00       	call   80104430 <release>
}
...
80102d0f:	e8 5c 16 00 00       	call   80104370 <acquire>
    wakeup(&log);
...
80102d31:	e8 fa 16 00 00       	call   80104430 <release>
...
80102d5c:	e8 cf 16 00 00       	call   80104430 <release>
...
80102dbe:	e8 ad 15 00 00       	call   80104370 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102e0c:	c9                   	leave  
  release(&log.lock);
80102e0d:	e9 1e 16 00 00       	jmp    80104430 <release>
...
80102ec7:	68 a8 65 11 80       	push   $0x801165a8
...
80103311:	e8 1a 0f 00 00       	call   80104230 <initlock>
  (*f0)->type = FD_PIPE;
...
8010336f:	e8 fc 0f 00 00       	call   80104370 <acquire>
  if(writable){
...
8010340d:	e8 5e 0f 00 00       	call   80104370 <acquire>
  for(i = 0; i < n; i++){
...
801034a4:	e8 87 0f 00 00       	call   80104430 <release>
        return -1;
...
801034fb:	e8 30 0f 00 00       	call   80104430 <release>
  return n;
...
80103520:	e8 4b 0e 00 00       	call   80104370 <acquire>
...
8010358e:	e8 9d 0e 00 00       	call   80104430 <release>
      return -1;
...
801035ef:	e8 3c 0e 00 00       	call   80104430 <release>
  return i;
...
80103621:	e8 4a 0d 00 00       	call   80104370 <acquire>
80103626:	83 c4 10             	add    $0x10,%esp
80103629:	eb 13                	jmp    8010363e <allocproc+0x2e>
8010362b:	90                   	nop
8010362c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103630:	81 c3 c0 00 00 00    	add    $0xc0,%ebx
80103636:	81 fb 54 5d 11 80    	cmp    $0x80115d54,%ebx
...
8010365f:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103665:	e8 c6 0d 00 00       	call   80104430 <release>
...
80103687:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010368a:	c7 40 14 72 56 10 80 	movl   $0x80105672,0x14(%eax)
  p->context = (struct context*)sp;
...
801036c2:	e8 69 0d 00 00       	call   80104430 <release>
}
...
80103740:	e8 eb 0a 00 00       	call   80104230 <initlock>
}
...
80103801:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103807:	e8 d4 0a 00 00       	call   801042e0 <popcli>
}
...
801038e0:	e8 8b 0a 00 00       	call   80104370 <acquire>
  p->state = RUNNABLE;
...
80103922:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103928:	e8 b3 09 00 00       	call   801042e0 <popcli>
  if(n > 0){
...
801039a3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039a9:	e8 32 09 00 00       	call   801042e0 <popcli>
  if((np = allocproc()) == 0){
...
80103a50:	e8 1b 09 00 00       	call   80104370 <acquire>
  np->state = RUNNABLE;
...
80103ade:	e8 8d 08 00 00       	call   80104370 <acquire>
...
80103b26:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b29:	81 c3 c0 00 00 00    	add    $0xc0,%ebx
80103b2f:	81 fb 54 5d 11 80    	cmp    $0x80115d54,%ebx
80103b35:	72 b9                	jb     80103af0 <scheduler+0x40>
    release(&ptable.lock);
80103b37:	83 ec 0c             	sub    $0xc,%esp
80103b3a:	68 20 2d 11 80       	push   $0x80112d20
80103b3f:	e8 ec 08 00 00       	call   80104430 <release>
    sti();
...
80103b72:	e8 c9 07 00 00       	call   80104340 <holding>
...
80103c82:	e8 e9 06 00 00       	call   80104370 <acquire>
...
80103c98:	05 c0 00 00 00       	add    $0xc0,%eax
80103c9d:	3d 54 5d 11 80       	cmp    $0x80115d54,%eax
...
80103caf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cb6:	05 c0 00 00 00       	add    $0xc0,%eax
80103cbb:	3d 54 5d 11 80       	cmp    $0x80115d54,%eax
...
80103ccf:	90                   	nop
80103cd0:	81 c2 c0 00 00 00    	add    $0xc0,%edx
80103cd6:	81 fa 54 5d 11 80    	cmp    $0x80115d54,%edx
...
80103cf8:	05 c0 00 00 00       	add    $0xc0,%eax
80103cfd:	3d 54 5d 11 80       	cmp    $0x80115d54,%eax
...
80103d27:	68 bd 74 10 80       	push   $0x801074bd
80103d2c:	e8 5f c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d31:	83 ec 0c             	sub    $0xc,%esp
80103d34:	68 b0 74 10 80       	push   $0x801074b0
...
80103d4c:	e8 1f 06 00 00       	call   80104370 <acquire>
  pushcli();
...
80103dd0:	e8 9b 05 00 00       	call   80104370 <acquire>
    release(lk);
...
80103e0b:	5d                   	pop    %ebp
    acquire(lk);
80103e0c:	e9 5f 05 00 00       	jmp    80104370 <acquire>
...
80103e72:	e8 f9 04 00 00       	call   80104370 <acquire>
...
80103e88:	81 c3 c0 00 00 00    	add    $0xc0,%ebx
80103e8e:	81 fb 54 5d 11 80    	cmp    $0x80115d54,%ebx
...
80103e9f:	74 37                	je     80103ed8 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ea1:	81 c3 c0 00 00 00    	add    $0xc0,%ebx
      havekids = 1;
80103ea7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103eac:	81 fb 54 5d 11 80    	cmp    $0x80115d54,%ebx
...
80103eea:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ef1:	e8 ca 2c 00 00       	call   80106bc0 <freevm>
        release(&ptable.lock);
...
80103f16:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f1d:	e8 0e 05 00 00       	call   80104430 <release>
        return pid;
...
80103f3b:	e8 f0 04 00 00       	call   80104430 <release>
      return -1;
...
80103f70:	05 c0 00 00 00       	add    $0xc0,%eax
80103f75:	3d 54 5d 11 80       	cmp    $0x80115d54,%eax
...
80103f87:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f8e:	05 c0 00 00 00       	add    $0xc0,%eax
80103f93:	3d 54 5d 11 80       	cmp    $0x80115d54,%eax
...
80103fa4:	c9                   	leave  
  release(&ptable.lock);
80103fa5:	e9 86 04 00 00       	jmp    80104430 <release>
...
80103fd0:	05 c0 00 00 00       	add    $0xc0,%eax
80103fd5:	3d 54 5d 11 80       	cmp    $0x80115d54,%eax
...
80103ffd:	e8 2e 04 00 00       	call   80104430 <release>
      return 0;
...
80104018:	e8 13 04 00 00       	call   80104430 <release>
  return -1;
...
8010404b:	68 57 78 10 80       	push   $0x80107857
80104050:	e8 0b c6 ff ff       	call   80100660 <cprintf>
80104055:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104058:	81 c3 c0 00 00 00    	add    $0xc0,%ebx
8010405e:	81 fb 54 5d 11 80    	cmp    $0x80115d54,%ebx
...
80104071:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104074:	ba e0 74 10 80       	mov    $0x801074e0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104079:	77 11                	ja     8010408c <procdump+0x5c>
8010407b:	8b 14 85 40 75 10 80 	mov    -0x7fef8ac0(,%eax,4),%edx
      state = "???";
80104082:	b8 e0 74 10 80       	mov    $0x801074e0,%eax
...
80104094:	68 e4 74 10 80       	push   $0x801074e4
...
801040bb:	e8 90 01 00 00       	call   80104250 <getcallerpcs>
...
801040d9:	68 21 6f 10 80       	push   $0x80106f21
...
80104203:	e8 e8 f5 ff ff       	call   801037f0 <myproc>
...
8010430c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104310:	e8 3b f4 ff ff       	call   80103750 <mycpu>
...
80104358:	e8 f3 f3 ff ff       	call   80103750 <mycpu>
...
801043b4:	e8 97 f3 ff ff       	call   80103750 <mycpu>
...
801054fe:	e8 ad ea ff ff       	call   80103fb0 <kill>
...
801055a0:	68 60 5d 11 80       	push   $0x80115d60
...
801055ad:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801055b0:	8b 1d a0 65 11 80    	mov    0x801165a0,%ebx
  while(ticks - ticks0 < n){
...
801055c3:	68 60 5d 11 80       	push   $0x80115d60
801055c8:	68 a0 65 11 80       	push   $0x801165a0
801055cd:	e8 be e7 ff ff       	call   80103d90 <sleep>
  while(ticks - ticks0 < n){
801055d2:	a1 a0 65 11 80       	mov    0x801165a0,%eax
...
801055f0:	68 60 5d 11 80       	push   $0x80115d60
...
80105613:	68 60 5d 11 80       	push   $0x80115d60
...
80105634:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105637:	68 60 5d 11 80       	push   $0x80115d60
8010563c:	e8 2f ed ff ff       	call   80104370 <acquire>
  xticks = ticks;
80105641:	8b 1d a0 65 11 80    	mov    0x801165a0,%ebx
  release(&tickslock);
80105647:	c7 04 24 60 5d 11 80 	movl   $0x80115d60,(%esp)
...
80105697:	c7 04 c5 a2 5d 11 80 	movl   $0x8e000008,-0x7feea25e(,%eax,8)
8010569e:	08 00 00 8e 
801056a2:	66 89 14 c5 a0 5d 11 	mov    %dx,-0x7feea260(,%eax,8)
801056a9:	80 
801056aa:	c1 ea 10             	shr    $0x10,%edx
801056ad:	66 89 14 c5 a6 5d 11 	mov    %dx,-0x7feea25a(,%eax,8)
801056b4:	80 
  for(i = 0; i < 256; i++)
...
801056c4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056c7:	c7 05 a2 5f 11 80 08 	movl   $0xef000008,0x80115fa2
801056ce:	00 00 ef 
  initlock(&tickslock, "time");
801056d1:	68 79 76 10 80       	push   $0x80107679
801056d6:	68 60 5d 11 80       	push   $0x80115d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056db:	66 a3 a0 5f 11 80    	mov    %ax,0x80115fa0
801056e1:	c1 e8 10             	shr    $0x10,%eax
801056e4:	66 a3 a6 5f 11 80    	mov    %ax,0x80115fa6
  initlock(&tickslock, "time");
...
8010570b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010570f:	b8 a0 5d 11 80       	mov    $0x80115da0,%eax
...
80105953:	68 60 5d 11 80       	push   $0x80115d60
80105958:	e8 13 ea ff ff       	call   80104370 <acquire>
      wakeup(&ticks);
8010595d:	c7 04 24 a0 65 11 80 	movl   $0x801165a0,(%esp)
      ticks++;
80105964:	83 05 a0 65 11 80 01 	addl   $0x1,0x801165a0
      wakeup(&ticks);
8010596b:	e8 e0 e5 ff ff       	call   80103f50 <wakeup>
      release(&tickslock);
80105970:	c7 04 24 60 5d 11 80 	movl   $0x80115d60,(%esp)
...
801067f0:	a1 a4 65 11 80       	mov    0x801165a4,%eax
{
...
80106ccb:	a3 a4 65 11 80       	mov    %eax,0x801165a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
