 ...
 459:	85 d2                	test   %edx,%edx
{
 ...
 487:	f7 f1                	div    %ecx
 489:	0f b6 92 24 0b 00 00 	movzbl 0xb24(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	e9 8f fe ff ff       	jmp    538 <printf+0x48>
          s = "(null)";
 6a9:	bb 1c 0b 00 00       	mov    $0xb1c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 40 0f 00 00       	mov    0xf40,%eax
{
 ...
 6fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ff:	a3 40 0f 00 00       	mov    %eax,0xf40
}
 704:	5b                   	pop    %ebx
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
 ...
 716:	72 ce                	jb     6e6 <free+0x26>
{
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 40 0f 00 00       	mov    %eax,0xf40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 40 0f 00 00    	mov    0xf40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 47                	jae    7e8 <malloc+0x98>
    ...
    if(p == freep)
 7a1:	39 05 40 0f 00 00    	cmp    %eax,0xf40
 ...
 7c6:	e8 f5 fe ff ff       	call   6c0 <free>
  return freep;
 7cb:	8b 15 40 0f 00 00    	mov    0xf40,%edx
 ...
 7f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7f7:	89 15 40 0f 00 00    	mov    %edx,0xf40
}
 ...
 809:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 40 0f 00 00 44 	movl   $0xf44,0xf40
 817:	0f 00 00 
 81a:	c7 05 44 0f 00 00 44 	movl   $0xf44,0xf44
 821:	0f 00 00 
    base.s.size = 0;
 824:	b8 44 0f 00 00       	mov    $0xf44,%eax
 829:	c7 05 48 0f 00 00 00 	movl   $0x0,0xf48
 830:	00 00 00 
...
int ourpower(int num) {
 853:	89 e5                	mov    %esp,%ebp
    for (int i = 0; i < num; i++)
 855:	7e 19                	jle    870 <ourpower.part.0+0x20>
 857:	31 d2                	xor    %edx,%edx
    int output = 1;
 859:	b9 01 00 00 00       	mov    $0x1,%ecx
 85e:	66 90                	xchg   %ax,%ax
    for (int i = 0; i < num; i++)
 860:	83 c2 01             	add    $0x1,%edx
        output *= 2;
 863:	01 c9                	add    %ecx,%ecx
    for (int i = 0; i < num; i++)
 865:	39 c2                	cmp    %eax,%edx
 867:	75 f7                	jne    860 <ourpower.part.0+0x10>
    return output;
}
 869:	89 c8                	mov    %ecx,%eax
 86b:	5d                   	pop    %ebp
 86c:	c3                   	ret    
 86d:	8d 76 00             	lea    0x0(%esi),%esi
    int output = 1;
 870:	b9 01 00 00 00       	mov    $0x1,%ecx
}
 875:	89 c8                	mov    %ecx,%eax
 877:	5d                   	pop    %ebp
 878:	c3                   	ret    
...
int ourpower(int num) {
 ...
 888:	78 03                	js     88d <ourpower+0xd>
}
 88a:	5d                   	pop    %ebp
 88b:	eb c3                	jmp    850 <ourpower.part.0>
 88d:	83 c8 ff             	or     $0xffffffff,%eax
 890:	5d                   	pop    %ebp
 891:	c3                   	ret    
...
trnmnt_tree_alloc(int depth){
 ...
 8a6:	bb 60 11 00 00       	mov    $0x1160,%ebx
trnmnt_tree_alloc(int depth){
 8ab:	83 ec 0c             	sub    $0xc,%esp
 8ae:	8b 45 08             	mov    0x8(%ebp),%eax
 8b1:	eb 13                	jmp    8c6 <trnmnt_tree_alloc+0x26>
 8b3:	90                   	nop
 8b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (t = treetable.trnmnt_tree ; t < &treetable.trnmnt_tree[NPROC] ; t++) {
 8b8:	81 c3 08 01 00 00    	add    $0x108,%ebx
 8be:	81 fb 60 53 00 00    	cmp    $0x5360,%ebx
 8c4:	73 42                	jae    908 <trnmnt_tree_alloc+0x68>
        if (t->active == INACTIVE)
 8c6:	8b 13                	mov    (%ebx),%edx
 8c8:	85 d2                	test   %edx,%edx
 8ca:	75 ec                	jne    8b8 <trnmnt_tree_alloc+0x18>
    if (num < 0) {
 8cc:	85 c0                	test   %eax,%eax
    ...
    found_tree:
    t->active = ACTIVE;
 8ce:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
    t->depth = depth;
 8d4:	89 43 04             	mov    %eax,0x4(%ebx)
    if (num < 0) {
 8d7:	78 1f                	js     8f8 <trnmnt_tree_alloc+0x58>
 8d9:	e8 72 ff ff ff       	call   850 <ourpower.part.0>

    for(int i=0; i<(ourpower(depth)-1); i++)
 8de:	31 f6                	xor    %esi,%esi
 8e0:	8d 78 ff             	lea    -0x1(%eax),%edi
 8e3:	eb 0f                	jmp    8f4 <trnmnt_tree_alloc+0x54>
 8e5:	8d 76 00             	lea    0x0(%esi),%esi
        t->trnmntMutex[i] = kthread_mutex_alloc();
 8e8:	e8 35 fb ff ff       	call   422 <kthread_mutex_alloc>
 8ed:	89 44 b3 08          	mov    %eax,0x8(%ebx,%esi,4)
    for(int i=0; i<(ourpower(depth)-1); i++)
 8f1:	83 c6 01             	add    $0x1,%esi
 8f4:	39 f7                	cmp    %esi,%edi
 8f6:	7f f0                	jg     8e8 <trnmnt_tree_alloc+0x48>

    return t;
}
 8f8:	83 c4 0c             	add    $0xc,%esp
 8fb:	89 d8                	mov    %ebx,%eax
 8fd:	5b                   	pop    %ebx
 8fe:	5e                   	pop    %esi
 8ff:	5f                   	pop    %edi
 900:	5d                   	pop    %ebp
 ...
 908:	83 c4 0c             	add    $0xc,%esp
    return 0;
 90b:	31 db                	xor    %ebx,%ebx
}
 90d:	89 d8                	mov    %ebx,%eax
 90f:	5b                   	pop    %ebx
 910:	5e                   	pop    %esi
 911:	5f                   	pop    %edi
 912:	5d                   	pop    %ebp
...
trnmnt_tree_dealloc(trnmnt_tree* tree){
 ...
 92c:	8b 06                	mov    (%esi),%eax
 92e:	85 c0                	test   %eax,%eax
 930:	74 56                	je     988 <trnmnt_tree_dealloc+0x68>
        return -1;
 ...
 934:	eb 2e                	jmp    964 <trnmnt_tree_dealloc+0x44>
 936:	8d 76 00             	lea    0x0(%esi),%esi
 939:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 940:	89 d8                	mov    %ebx,%eax
 942:	e8 09 ff ff ff       	call   850 <ourpower.part.0>
 947:	83 e8 01             	sub    $0x1,%eax
 94a:	39 c7                	cmp    %eax,%edi
 94c:	7d 47                	jge    995 <trnmnt_tree_dealloc+0x75>
        if(safe_tree_dealloc(tree->trnmntMutex[j]) == 0 )
 94e:	83 ec 0c             	sub    $0xc,%esp
 951:	ff 74 be 08          	pushl  0x8(%esi,%edi,4)
 955:	e8 e8 fa ff ff       	call   442 <safe_tree_dealloc>
 95a:	83 c4 10             	add    $0x10,%esp
 95d:	85 c0                	test   %eax,%eax
 95f:	74 27                	je     988 <trnmnt_tree_dealloc+0x68>
    for(int j=0; j<(ourpower(tree->depth)-1); j++){
 961:	83 c7 01             	add    $0x1,%edi
 964:	8b 5e 04             	mov    0x4(%esi),%ebx
    if (num < 0) {
 967:	85 db                	test   %ebx,%ebx
 969:	79 d5                	jns    940 <trnmnt_tree_dealloc+0x20>
    ...
    tree->depth=0;
 96b:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
    tree->active = INACTIVE;
 972:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
 ...
 9a0:	89 d8                	mov    %ebx,%eax
 9a2:	e8 a9 fe ff ff       	call   850 <ourpower.part.0>
 9a7:	83 e8 01             	sub    $0x1,%eax
 9aa:	39 f8                	cmp    %edi,%eax
 9ac:	7e bd                	jle    96b <trnmnt_tree_dealloc+0x4b>
        if(kthread_mutex_dealloc(tree->trnmntMutex[i]) == -1 ){
 9ae:	83 ec 0c             	sub    $0xc,%esp
 9b1:	ff 74 be 08          	pushl  0x8(%esi,%edi,4)
 9b5:	e8 70 fa ff ff       	call   42a <kthread_mutex_dealloc>
 9ba:	83 c4 10             	add    $0x10,%esp
 9bd:	83 f8 ff             	cmp    $0xffffffff,%eax
 9c0:	74 c6                	je     988 <trnmnt_tree_dealloc+0x68>
    for(int i=0; i<(ourpower(tree->depth)-1); i++){
 9c2:	8b 5e 04             	mov    0x4(%esi),%ebx
 9c5:	83 c7 01             	add    $0x1,%edi
    if (num < 0) {
 9c8:	85 db                	test   %ebx,%ebx
 9ca:	79 d4                	jns    9a0 <trnmnt_tree_dealloc+0x80>
 9cc:	eb 9d                	jmp    96b <trnmnt_tree_dealloc+0x4b>
 9ce:	66 90                	xchg   %ax,%ax

000009d0 <trnmnt_tree_acquire>:
...
trnmnt_tree_acquire(trnmnt_tree* tree,int ID){
 ...
 9dc:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    int x=0, localID=ID;
    for(int lvl=1; lvl<=tree->depth; lvl++){
 9df:	8b 46 04             	mov    0x4(%esi),%eax
 9e2:	85 c0                	test   %eax,%eax
 9e4:	7e 62                	jle    a48 <trnmnt_tree_acquire+0x78>
 9e6:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
    int x=0, localID=ID;
 ...
 9f2:	83 ec 0c             	sub    $0xc,%esp
        localID= localID/2;     //wich lock try to lock in current level
 9f5:	c1 e8 1f             	shr    $0x1f,%eax
 9f8:	01 c3                	add    %eax,%ebx
 9fa:	d1 fb                	sar    %ebx
        if(kthread_mutex_lock(tree->trnmntMutex[x+localID]) == -1)
 9fc:	8d 04 3b             	lea    (%ebx,%edi,1),%eax
 9ff:	ff 74 86 08          	pushl  0x8(%esi,%eax,4)
 a03:	e8 2a fa ff ff       	call   432 <kthread_mutex_lock>
 a08:	83 c4 10             	add    $0x10,%esp
 a0b:	83 f8 ff             	cmp    $0xffffffff,%eax
 a0e:	74 3a                	je     a4a <trnmnt_tree_acquire+0x7a>
 ...
 a10:	8b 4e 04             	mov    0x4(%esi),%ecx
    if (num < 0) {
 a13:	85 c9                	test   %ecx,%ecx
 a15:	78 31                	js     a48 <trnmnt_tree_acquire+0x78>
 a17:	89 c8                	mov    %ecx,%eax
 a19:	89 4d dc             	mov    %ecx,-0x24(%ebp)
 a1c:	e8 2f fe ff ff       	call   850 <ourpower.part.0>
 a21:	89 45 e0             	mov    %eax,-0x20(%ebp)
 a24:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 a27:	e8 24 fe ff ff       	call   850 <ourpower.part.0>
 a2c:	89 c1                	mov    %eax,%ecx
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 a2e:	8b 45 e0             	mov    -0x20(%ebp),%eax
    for(int lvl=1; lvl<=tree->depth; lvl++){
 a31:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 a35:	99                   	cltd   
 a36:	f7 f9                	idiv   %ecx
    for(int lvl=1; lvl<=tree->depth; lvl++){
 a38:	8b 4d dc             	mov    -0x24(%ebp),%ecx
        x+=((ourpower(tree->depth))/(ourpower(lvl))); //move x to point to the next level for localID
 a3b:	01 c7                	add    %eax,%edi
    for(int lvl=1; lvl<=tree->depth; lvl++){
 a3d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 a40:	39 c1                	cmp    %eax,%ecx
 a42:	7d ac                	jge    9f0 <trnmnt_tree_acquire+0x20>
...
trnmnt_tree_release(trnmnt_tree* tree,int ID){
 ...
 a69:	8b 7d 08             	mov    0x8(%ebp),%edi
    int x=ourpower(tree->depth)-2, localID;
 a6c:	8b 5f 04             	mov    0x4(%edi),%ebx
    if (num < 0) {
 a6f:	85 db                	test   %ebx,%ebx
 a71:	78 65                	js     ad8 <trnmnt_tree_release+0x78>
 a73:	89 d8                	mov    %ebx,%eax
 a75:	e8 d6 fd ff ff       	call   850 <ourpower.part.0>
    for(int lvl=tree->depth; lvl>=1; lvl--){
 a7a:	85 db                	test   %ebx,%ebx
 a7c:	8d 70 fe             	lea    -0x2(%eax),%esi
 a7f:	7f 24                	jg     aa5 <trnmnt_tree_release+0x45>
 a81:	eb 55                	jmp    ad8 <trnmnt_tree_release+0x78>
 a83:	90                   	nop
 ...
 a88:	8b 57 04             	mov    0x4(%edi),%edx
        return -1;
 a8b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
        x -= ourpower(tree->depth-lvl+1); //move x to point to the next level for localID
 a90:	29 da                	sub    %ebx,%edx
    if (num < 0) {
 a92:	83 c2 01             	add    $0x1,%edx
 a95:	78 07                	js     a9e <trnmnt_tree_release+0x3e>
 a97:	89 d0                	mov    %edx,%eax
 a99:	e8 b2 fd ff ff       	call   850 <ourpower.part.0>
        x -= ourpower(tree->depth-lvl+1); //move x to point to the next level for localID
 a9e:	29 c6                	sub    %eax,%esi
    for(int lvl=tree->depth; lvl>=1; lvl--){
 aa0:	83 eb 01             	sub    $0x1,%ebx
 aa3:	74 33                	je     ad8 <trnmnt_tree_release+0x78>
 aa5:	89 d8                	mov    %ebx,%eax
 aa7:	e8 a4 fd ff ff       	call   850 <ourpower.part.0>
 ...
 ab5:	f7 f9                	idiv   %ecx
        if(kthread_mutex_unlock(tree->trnmntMutex[x+localID]) == -1)
 ab7:	01 f0                	add    %esi,%eax
 ab9:	ff 74 87 08          	pushl  0x8(%edi,%eax,4)
 abd:	e8 78 f9 ff ff       	call   43a <kthread_mutex_unlock>
 ac2:	83 c4 10             	add    $0x10,%esp
 ac5:	83 f8 ff             	cmp    $0xffffffff,%eax
 ac8:	75 be                	jne    a88 <trnmnt_tree_release+0x28>
    }
    return 0;
}
 aca:	8d 65 f4             	lea    -0xc(%ebp),%esp
 acd:	5b                   	pop    %ebx
 ace:	5e                   	pop    %esi
 acf:	5f                   	pop    %edi
 ad0:	5d                   	pop    %ebp
